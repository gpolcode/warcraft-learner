...
| `npm run schema:pull` | Re-introspect the WCL v2 schema into `frontend/schema/wcl.graphql`, then run `codegen` over it - run it by hand to pick up a new WCL field, and commit both files |
