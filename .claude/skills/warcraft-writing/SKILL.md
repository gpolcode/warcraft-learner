...
- **Share card** - `frontend/public/og-image.png` (1200x630): the shield over the wordmark, a favicon derivative to regenerate with the logo. Backs `og:image` in `frontend/src/index.html` and `.github/pages-root/index.html`, which carry identical tags.
