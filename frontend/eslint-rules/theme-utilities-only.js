...
const BANNED = [
  ...
  { pattern: /\b(?:bg|border|fill|outline|accent)-\[var\(--/g, label: 'a color reached through var() instead of its named utility' },
  ...
  { pattern: /\btracking-(?:tighter|tight|normal|wide|wider|widest)\b/g, label: 'a tracking utility; text-label sets tracking' },
  { pattern: /\b(?:uppercase|lowercase|capitalize|normal-case|italic|not-italic)\b/g, label: 'a case or style utility; text-label is the only uppercase role' },
];
