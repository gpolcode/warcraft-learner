/** What a run ingests: the current raid zones with their encounters, the specs to ingest for, and whether the WCL point budget still allows a pass. */
import { logWarn } from '../core/log';
import { WclApiService, type WclExpansions, type WclGameClasses } from '../core/services/wcl-api';
