...
// Wording distinct from every feature's, so each assertion proves the value came from the adapter and not from the builder.
...
describe('buildWindowView detail rows', () => {
  ...
  it('carries the cast columns and the passive tag for a feature that asks for them', () => {
  ...
  it('omits the cast columns entirely for a feature that does not', () => {
