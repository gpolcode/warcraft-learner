...
import { SpecPlanLoaderService } from '../app/domains/raid-analysis/data/simc/spec-plan-loader-service';

export function provideApiFakes(fakes: { wcl: unknown; files?: unknown; plans?: unknown; talents?: unknown; enchantItems?: unknown; northernSkyPhases?: unknown }): Provider[] {
  return [
    ...
    { provide: SpecPlanLoaderService, useValue: (fakes.plans ?? {}) as SpecPlanLoaderService },
