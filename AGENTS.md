...
- **Never use em-dashes (U+2014), en-dashes (U+2013), or the Unicode minus (U+2212)** anywhere - docs, code comments, commit messages, UI copy, generated output. Use a plain ASCII hyphen (`-`) or rephrase.
