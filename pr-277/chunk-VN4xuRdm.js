...
`],encapsulation:2})}return t})();var so=(()=>{class t{static \u0275fac=function(n){return new(n||t)};static \u0275mod=HI({type:t});static \u0275inj=xl$1({imports:[J]})}return t})();function ur(t,o){if(t&1&&(oi$1(0,"span",2),nD(1),bc()),t&2){let e=_E();ov(),Cp(e.message());}}var Jm=(()=>{class t{message=iF("");static \u0275fac=function(n){return new(n||t)};static \u0275cmp=jI({type:t,selectors:[["wl-loading-spinner"]],inputs:{message:[1,"message"]},decls:3,vars:2,consts:[[1,"flex","flex-col","items-center","gap-3","p-12","text-[var(--muted)]"],[3,"diameter"],[1,"text-sm"]],template:function(n,i){n&1&&(oi$1(0,"div",0),np(1,"mat-spinner",1),aE(2,ur,2,1,"span",2),bc()),n&2&&(ov(),tp("diameter",36),ov(),cE(i.message()?2:-1));},dependencies:[so,lo],encapsulation:2})}return t})();function hr(t,o){t&1&&nD(0," The pre-fight plan is built entirely from top-parse logs. Gear, cooldown, defensive and burst plans all need parses - none are in yet. Here's what has to happen first: ");}function _r(t,o){t&1&&nD(0," Your pull graded against the spec rulebook below. Cooldown, burst, defensive and gear comparisons need top-parse logs - none are in yet. Here's what has to happen first: ");}function gr(t,o){t&1&&(oi$1(0,"div",8),nD(1,"Plan unlocks"),bc(),oi$1(2,"div",9),nD(3,"The cards below fill in."),bc());}function vr(t,o){t&1&&(oi$1(0,"div",8),nD(1,"Comparisons unlock"),bc(),oi$1(2,"div",9),nD(3,"The sections below fill in."),bc());}var ap=(()=>{class t{encounter=iF("");variant=iF("post");static \u0275fac=function(n){return new(n||t)};static \u0275cmp=jI({type:t,selectors:[["wl-bench-empty-banner"]],hostAttrs:[1,"block"],inputs:{encounter:[1,"encounter"],variant:[1,"variant"]},decls:42,vars:3,consts:[[1,"bg-[var(--surface)]","border","border-[var(--border)]","rounded-[10px]","p-4"],[1,"flex","items-start","gap-2.5"],[1,"icon-18","text-[var(--info)]","mt-px","shrink-0"],[1,"text-sm","font-semibold","text-[var(--text)]"],[1,"text-[12.5px]","text-[var(--muted)]","leading-relaxed","mt-0.5"],[1,"flex","items-stretch","gap-1","bg-[var(--bg)]","border","border-[var(--border)]","rounded-lg","px-4","py-3.5","mt-3.5"],[1,"flex-1","flex","flex-col","gap-1.5"],[1,"icon-seg","text-[var(--muted)]"],[1,"text-xs","font-semibold","text-[var(--text)]"],[1,"text-[11px]","text-[var(--muted)]","leading-snug"],[1,"font-mono","text-[10px]","text-[var(--critical)]","mt-px"],[1,"w-[26px]","shrink-0","flex","items-center","justify-center"],[1,"icon-16","text-[var(--border)]"],[1,"font-mono","text-[10px]","text-[var(--warning)]","mt-px"],[1,"icon-seg","text-[var(--success)]"],[1,"font-mono","text-[10px]","text-[var(--success)]","mt-px"]],template:function(n,i){n&1&&(oi$1(0,"div",0)(1,"div",1)(2,"mat-icon",2),nD(3,"info"),bc(),oi$1(4,"div")(5,"div",3),nD(6),bc(),oi$1(7,"div",4),aE(8,hr,1,0)(9,_r,1,0),bc()()(),oi$1(10,"div",5)(11,"div",6)(12,"mat-icon",7),nD(13,"military_tech"),bc(),oi$1(14,"div",8),nD(15,"Mythic kills logged"),bc(),oi$1(16,"div",9),nD(17,"Players upload to WCL."),bc(),oi$1(18,"div",10),nD(19,"waiting"),bc()(),oi$1(20,"div",11)(21,"mat-icon",12),nD(22,"arrow_forward"),bc()(),oi$1(23,"div",6)(24,"mat-icon",7),nD(25,"cloud_sync"),bc(),oi$1(26,"div",8),nD(27,"Ingest samples them"),bc(),oi$1(28,"div",9),nD(29,"We pull new top rankings."),bc(),oi$1(30,"div",13),nD(31,"hourly"),bc()(),oi$1(32,"div",11)(33,"mat-icon",12),nD(34,"arrow_forward"),bc()(),oi$1(35,"div",6)(36,"mat-icon",14),nD(37,"check_circle"),bc(),aE(38,gr,4,0)(39,vr,4,0),oi$1(40,"div",15),nD(41,"automatic"),bc()()()()),n&2&&(ov(6),xc("No benchmark for ",i.encounter()," yet"),ov(2),cE(i.variant()==="pre"?8:9),ov(30),cE(i.variant()==="pre"?38:39));},dependencies:[hv,uv],encapsulation:2})}return t})();var Bt=(()=>{class t{transform(e){if(e==null)return "-";if(!Number.isFinite(e))return "0:00";let n=e<0?"-":"",i=Math.abs(e),a=Math.floor(i/60),r=Math.floor(i%60);return `${n}${a}:${String(r).padStart(2,"0")}`}static \u0275fac=function(n){return new(n||t)};static \u0275pipe=WI({name:"formatDuration",type:t,pure:true})}return t})();function xr(t,o){if(t&1&&(oi$1(0,"div",3),nD(1),bc()),t&2){let e=_E(2);ov(),Cp(e.subtitle());}}function br(t,o){if(t&1&&(oi$1(0,"div",1)(1,"div",2),nD(2),bc(),aE(3,xr,2,1,"div",3),bc()),t&2){let e=_E();ov(2),Cp(e.heading()),ov(),cE(e.subtitle()?3:-1);}}function yr(t,o){if(t&1&&(oi$1(0,"mat-icon",4),nD(1),bc(),oi$1(2,"div",5),nD(3),bc(),oi$1(4,"div",6),nD(5),bc()),t&2){_E();let e=aD(0);ov(),Cp(e.kind==="permanent"?"error":"cloud_off"),ov(2),Cp(e.message),ov(2),xc(" ",e.kind==="permanent"?"This analysis is bugged. Retrying will not fix it.":"Retries on the next sync, or reselect the fight."," ");}}function wr(t,o){if(t&1&&(oi$1(0,"div",6),nD(1),bc()),t&2){let e=_E(2);ov(),Cp(e.caption());}}function Cr(t,o){if(t&1&&(oi$1(0,"mat-icon",7),nD(1,"schedule"),bc(),oi$1(2,"div",5),nD(3,"Waiting for top parses"),bc(),aE(4,wr,2,1,"div",6)),t&2){let e=_E();ov(4),cE(e.caption()?4:-1);}}var Xe=(()=>{class t{heading=iF("");subtitle=iF("");caption=iF("Built from the top-parse bench.");error=iF(null);static \u0275fac=function(n){return new(n||t)};static \u0275cmp=jI({type:t,selectors:[["wl-load-state"]],hostAttrs:[1,"block"],inputs:{heading:[1,"heading"],subtitle:[1,"subtitle"],caption:[1,"caption"],error:[1,"error"]},decls:6,vars:6,consts:[[1,"bg-[var(--surface)]","border","border-[var(--border)]","rounded-[10px]","overflow-hidden"],[1,"px-4","pt-3","pb-2"],[1,"text-[17px]","font-semibold","text-[var(--text)]"],[1,"text-xs","text-[var(--muted)]","mt-0.5"],[1,"icon-seg","text-[var(--info)]"],[1,"text-[13px]","text-[var(--muted)]"],[1,"text-[11.5px]","text-[var(--muted)]/70"],[1,"icon-seg","text-[var(--muted)]"]],template:function(n,i){if(n&1&&(Sp(0),oi$1(1,"div",0),aE(2,br,4,2,"div",1),oi$1(3,"div"),aE(4,yr,6,3)(5,Cr,5,1),bc()()),n&2){let a=sD(i.error());ov(2),cE(i.heading()?2:-1),ov(),qE(cD("px-4 py-6 flex flex-col items-center gap-2 text-center ",i.heading()?"border-t border-dashed border-[var(--border)]":"")),ov(),cE(a?4:5);}},dependencies:[hv,uv],encapsulation:2})}return t})();var Sr="wh-tooltips-config.js",Mr="https://wow.zamimg.com/js/tooltips.js",co=(()=>{class t{document=T(Jn);loaded=false;ready=false;refreshScheduled=false;ensureLoaded(){if(this.loaded)return;this.loaded=true;let e=this.document.createElement("script");e.src=Sr,e.addEventListener("error",n=>ua$1("wowhead tooltips config load",n)),e.addEventListener("load",()=>{let n=this.document.createElement("script");n.src=Mr,n.addEventListener("error",i=>ua$1("wowhead tooltips script load",i)),n.addEventListener("load",()=>{this.ready=true,this.refreshLinks();}),this.document.head.appendChild(n);}),this.document.head.appendChild(e);}refreshLinks(){this.refreshScheduled||(this.refreshScheduled=true,queueMicrotask(()=>{this.refreshScheduled=false,this.ready&&this.document.defaultView?.$WowheadPower?.refreshLinks?.();}));}static \u0275fac=function(n){return new(n||t)};static \u0275prov=oe({token:t,factory:t.\u0275fac,providedIn:"root"})}return t})();function Dr(t,o){if(t&1){let e=vE();oi$1(0,"img",3),cp("error",function(){tu(e);let i=_E(),a=_E();return nu(a.failedSrc.set(i))}),bc();}if(t&2){let e=_E();tp("ngSrc",e)("width",18)("height",18);}}function kr(t,o){if(t&1&&aE(0,Dr,1,3,"img",2),t&2){let e=_E();cE(e.failedSrc()!==o?0:-1);}}var Ze=(()=>{class t{constructor(){let e=T(co);Oy(()=>{e.ensureLoaded(),e.refreshLinks();});}id=iF.required();kind=iF("spell");name=iF.required();icon=iF.required();failedSrc=So$1(null);iconUrl=TD(()=>{let e=this.icon().replace(/\.(jpg|jpeg|png|gif|webp)$/i,"");return e?`https://wow.zamimg.com/images/wow/icons/small/${e}.jpg`:null});wowheadUrl=TD(()=>`https://www.wowhead.com/${this.kind()}=${this.id()}`);static \u0275fac=function(n){return new(n||t)};static \u0275cmp=jI({type:t,selectors:[["wl-game-icon"]],hostAttrs:[1,"inline-flex","items-center"],inputs:{id:[1,"id"],kind:[1,"kind"],name:[1,"name"],icon:[1,"icon"]},decls:4,vars:3,consts:[["target","_blank","rel","noopener",1,"inline-flex","items-center","gap-1.5","no-underline","hover:brightness-125",3,"href"],[1,"text-sm"],["alt","",1,"rounded-sm",3,"ngSrc","width","height"],["alt","",1,"rounded-sm",3,"error","ngSrc","width","height"]],template:function(n,i){if(n&1&&(oi$1(0,"a",0),aE(1,kr,1,1),oi$1(2,"span",1),nD(3),bc()()),n&2){let a;tp("href",i.wowheadUrl(),Qd),ov(),cE((a=i.iconUrl())?1:-1,a),ov(2),Cp(i.name());}},dependencies:[cf],encapsulation:2})}return t})();var Wt=(()=>{class t{transform(e){return e==null?"":e>=1e6||Math.round(e/1e3)>=1e3?`${(e/1e6).toFixed(1)}M`:e>=1e3?`${Math.round(e/1e3)}K`:String(Math.round(e))}static \u0275fac=function(n){return new(n||t)};static \u0275pipe=WI({name:"formatDamage",type:t,pure:true})}return t})();function Tr(t,o){if(t&1&&np(0,"wl-game-icon",3),t&2){let e=_E();tp("id",o)("icon",e.row().icon)("name",e.row().label);}}function Er(t,o){if(t&1&&(oi$1(0,"span",4),nD(1),bc()),t&2){let e=_E();ov(),Cp(e.row().label);}}function Ir(t,o){t&1&&nD(0," missed ");}function Fr(t,o){if(t&1&&(nD(0),mD(1,"formatDamage")),t&2){let e=_E(2);bp(" ",e.gapSign(),"",vD(1,2,e.gapMagnitude())," ");}}function Or(t,o){if(t&1&&(oi$1(0,"span",9),aE(1,Ir,1,0)(2,Fr,2,4),bc()),t&2){let e=_E();yp("badge-success",e.gapStatus()==="success")("badge-warning",e.gapStatus()==="warning")("badge-critical",e.gapStatus()==="critical")("badge-muted",e.gapStatus()==="muted"),ov(),cE(e.row().playerPct==null?1:2);}}function Ar(t,o){t&1&&(oi$1(0,"span",10),nD(1,"passive"),bc());}function Rr(t,o){if(t&1&&(oi$1(0,"span",11),nD(1,"Casts"),bc(),oi$1(2,"span",12),nD(3),oi$1(4,"span",13),nD(5),bc()()),t&2){let e=_E(2);ov(2),yp("badge-success",e.castsStatus()==="success")("badge-warning",e.castsStatus()==="warning")("badge-critical",e.castsStatus()==="critical")("badge-muted",e.castsStatus()==="muted"),ov(),xc(" ",e.row().playerCasts??0),ov(2),xc(" / ",e.row().topCasts??"-");}}function Pr(t,o){if(t&1&&aE(0,Ar,2,0,"span",10)(1,Rr,6,10),t&2){let e=_E();cE(e.isPassive()?0:1);}}var mo=(()=>{class t{row=iF.required();higherIsBetter=iF(true);showCasts=iF(true);hidePlayer=iF(false);gap=TD(()=>{let{playerPct:e,topAvg:n}=this.row();return e==null||n==null?null:e-n});gapSign=TD(()=>(this.gap()??0)>=0?"+":"-");gapMagnitude=TD(()=>Math.abs(this.gap()??0));gapStatus=TD(()=>{let{playerPct:e,topAvg:n}=this.row();if(e==null)return "critical";let i=this.gap();return i==null||n==null||n===0?"muted":(this.higherIsBetter()?i:-i)>=0?"success":Math.abs(i)<=n*.1?"warning":"critical"});isPassive=TD(()=>this.row().passive===true);castsStatus=TD(()=>{let{playerCasts:e,topCasts:n}=this.row();if(n==null)return "muted";let i=e??0;return i>=n?"success":n-i<=1?"warning":"critical"});static \u0275fac=function(n){return new(n||t)};static \u0275cmp=jI({type:t,selectors:[["wl-compact-ability-row"]],inputs:{row:[1,"row"],higherIsBetter:[1,"higherIsBetter"],showCasts:[1,"showCasts"],hidePlayer:[1,"hidePlayer"]},decls:13,vars:6,consts:[[1,"md:grid","md:grid-cols-[minmax(0,1fr)_96px_96px_90px]","md:gap-x-[14px]","md:items-center","px-4","py-1.5","min-w-0","border-t","md:border-t-0","border-[var(--border)]"],[1,"flex","items-baseline","gap-2","min-w-0","md:contents"],[1,"flex-1","min-w-0","overflow-hidden","md:col-start-1","md:row-start-1"],[3,"id","icon","name"],[1,"truncate","text-sm"],[1,"shrink-0","md:col-start-4","md:row-start-1","text-right","tabular-nums","text-xs","font-semibold",3,"badge-success","badge-warning","badge-critical","badge-muted"],[1,"flex","items-baseline","flex-wrap","gap-x-1.5","gap-y-1","mt-1.5","md:mt-0","md:contents"],[1,"shrink-0","mr-2","md:mr-0","md:col-start-3","md:row-start-1","md:text-left","tabular-nums","text-xs","text-[var(--muted)]"],[1,"md:hidden","font-mono","text-[10px]","uppercase","tracking-wider"],[1,"shrink-0","md:col-start-4","md:row-start-1","text-right","tabular-nums","text-xs","font-semibold"],[1,"shrink-0","md:col-start-2","md:row-start-1","w-auto","text-center","text-xs","rounded","px-2","py-0.5","border","border-current","badge-muted"],[1,"md:hidden","font-mono","text-[10px]","uppercase","tracking-wider","text-[var(--muted)]"],[1,"shrink-0","md:col-start-2","md:row-start-1","w-auto","text-center","tabular-nums","text-xs","rounded","px-2","py-0.5","border","border-current"],[1,"text-[var(--muted)]"]],template:function(n,i){if(n&1&&(oi$1(0,"div",0)(1,"div",1)(2,"div",2),aE(3,Tr,1,3,"wl-game-icon",3)(4,Er,2,1,"span",4),bc(),aE(5,Or,3,9,"span",5),bc(),oi$1(6,"div",6)(7,"span",7)(8,"span",8),nD(9,"Top avg "),bc(),nD(10),mD(11,"formatDamage"),bc(),aE(12,Pr,2,1),bc()()),n&2){let a;ov(3),cE((a=i.row().spellId)?3:4,a),ov(2),cE(i.hidePlayer()?-1:5),ov(5),xc("",vD(11,4,i.row().topAvg)," "),ov(2),cE(i.showCasts()&&!i.hidePlayer()?12:-1);}},dependencies:[Ze,Wt],encapsulation:2})}return t})();var po=(()=>{class t{transform(e){if(e==null||!Number.isFinite(e))return "";let n=Math.round(e);return `${n>0?"+":""}${n}%`}static \u0275fac=function(n){return new(n||t)};static \u0275pipe=WI({name:"signedPercent",type:t,pure:true})}return t})();var Nr=(t,o)=>o.kind==="window"?"w"+o.index:"g"+o.id,Lr=(t,o)=>o.id,$r=(t,o)=>o.spellId;function Br(t,o){if(t&1&&(oi$1(0,"div",6),nD(1),bc()),t&2){let e=_E(2);ov(),Cp(e.subtitle());}}function Wr(t,o){if(t&1&&(oi$1(0,"div",1)(1,"div",5),nD(2),bc(),aE(3,Br,2,1,"div",6),bc()),t&2){let e=_E();ov(2),Cp(e.heading()),ov(),cE(e.subtitle()?3:-1);}}function zr(t,o){t&1&&(oi$1(0,"div",7),np(1,"div",9),oi$1(2,"span",10),nD(3,"0"),bc()());}function jr(t,o){if(t&1){let e=vE();oi$1(0,"div",8)(1,"button",11),mD(2,"formatDuration"),cp("click",function(){tu(e);let i=_E().$implicit,a=_E();return nu(a.select(i.index))}),oi$1(3,"mat-icon",12),nD(4),bc(),np(5,"span",13),bc(),oi$1(6,"span"),nD(7),mD(8,"formatDuration"),bc()();}if(t&2){let e=_E().$implicit,n=_E(),i=n.windows()[e.index],a=n.activeIndex()===e.index,r=i.status==="good"?"text-[var(--success)]":i.status==="warn"?"text-[var(--warning)]":i.status==="bad"?"text-[var(--critical)]":i.status==="info"?"text-[var(--info)]":"text-[var(--muted)]",l=i.status==="good"?"bg-[var(--success)]":i.status==="warn"?"bg-[var(--warning)]":i.status==="bad"?"bg-[var(--critical)]":i.status==="info"?"bg-[var(--info)]":"bg-[var(--muted)]";ov(),qE("relative flex items-center justify-center w-10 h-10 rounded-lg overflow-hidden bg-[var(--bg)] border border-[var(--border)] "+r+(a?" outline outline-2 outline-offset-0 outline-[var(--gold)]":" focus:outline-none")),tp("id",n.optionId(e.index)),ep("aria-selected",a)("aria-label",vD(2,11,i.timeStartS)),ov(3),Cp(i.statusIcon),ov(),qE("absolute bottom-0 left-0 right-0 h-1 "+l),ov(),qE("tabular-nums text-[10px] "+(a?"text-[var(--gold)]":"text-[var(--muted)]")),ov(),xc(" ",vD(8,13,i.timeStartS)," ");}}function Gr(t,o){if(t&1&&aE(0,zr,4,0,"div",7)(1,jr,9,15,"div",8),t&2){let e=o.$implicit;cE(e.kind==="gap"?0:1);}}function Vr(t,o){if(t&1&&(oi$1(0,"span",19),nD(1),mD(2,"formatDamage"),bc()),t&2){let e=_E();ov(),Cp(vD(2,1,e.overview.playerPct));}}function qr(t,o){if(t&1&&(oi$1(0,"span",19),nD(1),mD(2,"formatDamage"),bc()),t&2){let e=_E();ov(),Cp(vD(2,1,e.overview.topAvg));}}function Hr(t,o){t&1&&(oi$1(0,"span",20),nD(1,"not reached"),bc());}function Ur(t,o){if(t&1&&(oi$1(0,"div",16)(1,"span",17),nD(2,"vs top average"),bc(),oi$1(3,"span",27),nD(4),mD(5,"signedPercent"),bc()()),t&2){let e=_E(2);ov(3),yp("badge-muted",e.overviewDeltaStatus()==="muted")("badge-success",e.overviewDeltaStatus()==="better")("badge-critical",e.overviewDeltaStatus()==="worse"),ov(),Cp(vD(5,7,e.overviewDelta()));}}function Qr(t,o){if(t&1){let e=vE();oi$1(0,"button",28),cp("click",function(){tu(e);let i=_E(2);return nu(i.openMap.emit(i.activeIndex()))}),oi$1(1,"mat-icon"),nD(2,"my_location"),bc()();}}function Kr(t,o){if(t&1){let e=vE();oi$1(0,"button",29),cp("click",function(){tu(e);let i=_E(2);return nu(i.openClip.emit(i.activeIndex()))}),oi$1(1,"mat-icon"),nD(2,"videocam"),bc()();}}function Yr(t,o){if(t&1&&(oi$1(0,"span",32),np(1,"wl-game-icon",33),bc()),t&2){let e=o.$implicit;ov(),tp("id",e.id)("icon",e.icon)("name",e.name);}}function Xr(t,o){if(t&1&&(oi$1(0,"span",32)(1,"span",34),nD(2),bc()()),t&2){let e=o.$implicit;ov(2),Cp(e);}}function Zr(t,o){if(t&1&&(oi$1(0,"div",24)(1,"span",30),nD(2,"Recommended cooldowns"),bc(),oi$1(3,"div",31),dE(4,Yr,2,3,"span",32,Lr),dE(6,Xr,3,1,"span",32,uE),bc()()),t&2){let e=_E();ov(4),fE(e.spells),ov(2),fE(e.labels);}}function Jr(t,o){if(t&1&&np(0,"div"),t&2){_E(2);let e=aD(0),n=_E();qE("absolute inset-y-0 left-0 rounded opacity-[0.65] "+e),mp("width",n.overviewPlayerWidthPct(),"%");}}function el(t,o){if(t&1&&np(0,"div",39),t&2){let e=_E(3);mp("left",e.overviewRangeLeftPct(),"%")("width",e.overviewRangeWidthPct(),"%");}}function tl(t,o){if(t&1&&np(0,"div",40),t&2){let e=_E(3);mp("left",e.overviewAvgLeftPct(),"%");}}function nl(t,o){if(t&1&&(oi$1(0,"div",25)(1,"span",30),nD(2,"Damage vs top range"),bc(),oi$1(3,"div",35),aE(4,Jr,1,4,"div",36),aE(5,el,1,4,"div",37),aE(6,tl,1,2,"div",38),bc()()),t&2){let e=_E(2);ov(4),cE(e.overviewPlayerWidthPct()!==null?4:-1),ov(),cE(e.overviewRangeLeftPct()!==null?5:-1),ov(),cE(e.overviewAvgLeftPct()!==null?6:-1);}}function il(t,o){t&1&&(oi$1(0,"span",43),nD(1,"casts"),bc());}function ol(t,o){t&1&&(oi$1(0,"span",45),nD(1,"gap"),bc());}function al(t,o){if(t&1&&np(0,"wl-compact-ability-row",46),t&2){let e=o.$implicit,n=_E(3);tp("row",e)("higherIsBetter",n.higherIsBetter())("showCasts",n.showCasts())("hidePlayer",n.activeIsMuted());}}function rl(t,o){if(t&1&&(oi$1(0,"div",26)(1,"div",41)(2,"span",42),nD(3,"ability"),bc(),aE(4,il,2,0,"span",43),oi$1(5,"span",44),nD(6,"top avg"),bc(),aE(7,ol,2,0,"span",45),bc(),dE(8,al,1,4,"wl-compact-ability-row",46,$r),bc()),t&2){let e=_E(2);ov(4),cE(e.showCasts()&&!e.activeIsMuted()?4:-1),ov(3),cE(e.activeIsMuted()?-1:7),ov(),fE(e.activeDetailRows());}}function ll(t,o){if(t&1&&(Sp(0),oi$1(1,"div",14)(2,"div",15)(3,"div",16)(4,"span",17),nD(5,"window"),bc(),oi$1(6,"span",18),nD(7),mD(8,"formatDuration"),mD(9,"formatDuration"),bc()(),oi$1(10,"div",16)(11,"span",17),nD(12,"burst"),bc(),aE(13,Vr,3,3,"span",19)(14,qr,3,3,"span",19)(15,Hr,2,0,"span",20),bc(),aE(16,Ur,6,9,"div",16),oi$1(17,"div",21),aE(18,Qr,3,0,"button",22),aE(19,Kr,3,0,"button",23),bc()(),aE(20,Zr,8,0,"div",24),bc(),aE(21,nl,7,3,"div",25),aE(22,rl,10,2,"div",26)),t&2){let e=o,n=_E();sD(e.status==="good"?"bg-[var(--success)]":e.status==="warn"?"bg-[var(--warning)]":e.status==="bad"?"bg-[var(--critical)]":e.status==="muted"?"bg-[var(--muted)]":"bg-[var(--info)]"),ov(7),bp(" ",vD(8,10,e.timeStartS)," - ",vD(9,12,e.timeEndS)," "),ov(6),cE(n.activeIsMuted()?n.activeIsBenchOnly()?14:15:13),ov(3),cE(!n.activeIsMuted()&&n.overviewDelta()!==null?16:-1),ov(2),cE(n.showMap()?18:-1),ov(),cE(n.showClip()?19:-1),ov(),cE(e.spells.length||e.labels.length?20:-1),ov(),cE(n.activeIsBenchOnly()?-1:21),ov(),cE(e.detailRows.length?22:-1);}}var sl=0,uo=(()=>{class t{windows=iF.required();higherIsBetter=iF(true);showMap=iF(false);showClip=iF(false);showCasts=iF(true);heading=iF("");subtitle=iF("");openMap=oF();openClip=oF();static GAP_SLOT_SECONDS=20;selectedIndex=TD(()=>{let e=this.windows(),n=this.higherIsBetter(),i=0,a=n?1/0:-1/0;return e.forEach((r,l)=>{if(r.status==="muted")return;let s=r.overview.playerPct,m=r.overview.topAvg;if(s==null||!m||m<=0)return;let f=s/m;(n?f<a:f>a)&&(a=f,i=l);}),i});_manualIndex=_D({source:this.windows,computation:()=>null});activeIndex=TD(()=>this._manualIndex()??this.selectedIndex());activeWindow=TD(()=>this.windows()[this.activeIndex()]??null);instanceId=`wl-window-comparison-${sl++}`;optionId(e){return `${this.instanceId}-opt-${e}`}activeOptionId=TD(()=>this.optionId(this.activeIndex()));timelineCells=TD(()=>{let e=this.windows(),n=[];return e.forEach((i,a)=>{n.push({kind:"window",index:a});let r=e[a+1];if(!r)return;let l=this.gapSlots(r.timeStartS-i.timeEndS);for(let s=0;s<l;s++)n.push({kind:"gap",id:`${a}-${s}`});}),n});gapSlots(e){return Math.max(0,Math.floor(e/t.GAP_SLOT_SECONDS))}select(e){this._manualIndex.set(e);}onKeydown(e){let n=e.key==="ArrowRight"?1:e.key==="ArrowLeft"?-1:0;if(!n)return;e.preventDefault();let i=this.activeIndex()+n;i>=0&&i<this.windows().length&&this.select(i);}activeIsMuted=TD(()=>{let e=this.activeWindow()?.status;return e==="muted"||e==="info"});activeIsBenchOnly=TD(()=>this.activeWindow()?.status==="info");activeDetailRows=TD(()=>{let e=this.activeWindow()?.detailRows??[],n=this.higherIsBetter(),i=a=>{if(a.playerPct==null)return -(a.topAvg??0);let r=a.playerPct-(a.topAvg??0);return n?r:-r};return [...e].sort((a,r)=>i(a)-i(r))});overviewMax=TD(()=>{let e=this.windows().flatMap(n=>[n.overview.topAvg,n.overview.topMax,n.overview.playerPct].filter(i=>i!=null&&Number.isFinite(i)));return Math.max(...e,.01)});barPct(e,n){let i=e/n*100;return Number.isFinite(i)?Math.min(100,Math.max(0,i)):0}overviewDelta=TD(()=>{let e=this.activeWindow();if(!e)return null;let{playerPct:n,topAvg:i}=e.overview;if(n==null||i==null||i===0)return null;let a=(n-i)/i*100;return Number.isFinite(a)?a:null});overviewDeltaStatus=TD(()=>{let e=this.overviewDelta();return e==null?"muted":(this.higherIsBetter()?e>=0:e<=0)?"better":"worse"});overviewPlayerWidthPct=TD(()=>{let e=this.activeWindow();return !e||e.overview.playerPct==null?null:this.barPct(e.overview.playerPct,this.overviewMax())});overviewRangeLeftPct=TD(()=>{let e=this.activeWindow();return !e||e.overview.topMin==null||e.overview.topMax==null?null:this.barPct(e.overview.topMin,this.overviewMax())});overviewRangeWidthPct=TD(()=>{let e=this.activeWindow();if(!e||e.overview.topMin==null||e.overview.topMax==null)return null;let n=this.overviewMax();return Math.max(0,this.barPct(e.overview.topMax,n)-this.barPct(e.overview.topMin,n))});overviewAvgLeftPct=TD(()=>{let e=this.activeWindow();return !e||e.overview.topAvg==null?null:this.barPct(e.overview.topAvg,this.overviewMax())});static \u0275fac=function(n){return new(n||t)};static \u0275cmp=jI({type:t,selectors:[["wl-window-comparison"]],hostAttrs:[1,"block"],inputs:{windows:[1,"windows"],higherIsBetter:[1,"higherIsBetter"],showMap:[1,"showMap"],showClip:[1,"showClip"],showCasts:[1,"showCasts"],heading:[1,"heading"],subtitle:[1,"subtitle"]},outputs:{openMap:"openMap",openClip:"openClip"},decls:8,vars:8,consts:[[1,"bg-[var(--surface)]","border","border-[var(--border)]","rounded-[10px]","overflow-hidden"],[1,"px-4","pt-3","pb-2"],[1,"px-4"],["role","listbox","tabindex","0",1,"pt-2","pb-1",3,"keydown"],[1,"flex","flex-wrap","items-start","gap-1.5","px-0.5"],[1,"text-[17px]","font-semibold","text-[var(--text)]"],[1,"text-xs","text-[var(--muted)]","mt-0.5"],["aria-hidden","true",1,"flex","flex-col","items-center","gap-1.5","shrink-0"],[1,"flex","flex-col","items-center","gap-1.5","shrink-0"],[1,"w-5","h-10","rounded-md","border","border-dashed","border-[var(--border)]","opacity-40"],[1,"text-[10px]","invisible"],["type","button","role","option","tabindex","-1",3,"click","id"],[1,"icon-seg"],["aria-hidden","true"],[1,"px-4","py-2.5","bg-[var(--surface)]","border-t","border-[var(--border)]"],[1,"flex","items-center","gap-4","md:gap-[22px]"],[1,"flex","flex-col","shrink-0"],[1,"text-[9px]","uppercase","tracking-[1px]","text-[var(--muted)]"],[1,"text-[13px]","font-semibold","tabular-nums","text-[var(--text)]","whitespace-nowrap"],[1,"text-[13px]","font-semibold","tabular-nums","text-[var(--text)]"],[1,"text-[13px]","font-semibold","italic","text-[var(--muted)]"],[1,"ml-auto","flex","items-center","gap-[7px]","shrink-0"],["mat-icon-button","","title","Open positioning map"],["mat-icon-button","","title","Watch clip"],[1,"mt-2.5"],[1,"px-4","pb-2"],[1,"md:border-t","border-[var(--border)]","pt-2","pb-2"],[1,"text-[13px]","font-semibold","tabular-nums"],["mat-icon-button","","title","Open positioning map",3,"click"],["mat-icon-button","","title","Watch clip",3,"click"],[1,"block","text-[10px]","uppercase","tracking-widest","text-[var(--muted)]","mb-1.5"],[1,"flex","flex-wrap","items-center","gap-2"],[1,"chip-onplan"],[3,"id","icon","name"],[1,"text-[13px]","text-[var(--muted)]"],["aria-hidden","true",1,"relative","h-5","rounded","bg-[var(--bg)]"],[3,"class","width"],[1,"absolute","inset-y-0","rounded","bg-[var(--info)]/30","border","border-[var(--info)]",3,"left","width"],[1,"absolute","inset-y-0","w-[2px]","bg-[var(--info)]",3,"left"],[1,"absolute","inset-y-0","rounded","bg-[var(--info)]/30","border","border-[var(--info)]"],[1,"absolute","inset-y-0","w-[2px]","bg-[var(--info)]"],[1,"hidden","md:grid","grid-cols-[minmax(0,1fr)_96px_96px_90px]","gap-x-[14px]","items-center","px-4","pb-1"],[1,"col-start-1","text-[10px]","uppercase","tracking-widest","text-[var(--muted)]"],[1,"col-start-2","text-right","text-[10px]","uppercase","tracking-widest","text-[var(--muted)]"],[1,"col-start-3","text-left","text-[10px]","uppercase","tracking-widest","text-[var(--muted)]"],[1,"col-start-4","text-right","text-[10px]","uppercase","tracking-widest","text-[var(--muted)]"],[3,"row","higherIsBetter","showCasts","hidePlayer"]],template:function(n,i){if(n&1&&(oi$1(0,"div",0),aE(1,Wr,4,2,"div",1),oi$1(2,"div",2)(3,"div",3),cp("keydown",function(r){return i.onKeydown(r)}),oi$1(4,"div",4),dE(5,Gr,2,1,null,null,Nr),bc()()(),aE(7,ll,23,14),bc()),n&2){let a;ov(),cE(i.heading()?1:-1),ov(),yp("pt-3",!i.heading())("pb-3",!i.activeWindow()),ov(),ep("aria-label",i.heading())("aria-activedescendant",i.activeOptionId()),ov(2),fE(i.timelineCells()),ov(2),cE((a=i.activeWindow())?7:-1,a);}},dependencies:[hv,uv,xb,Hd,Ze,mo,Bt,Wt,po],encapsulation:2})}return t})();var Je=class{token=0;run(o,e){let n=++this.token;o.then(i=>{n===this.token&&e.apply(i);}).catch(i=>ua$1(e.context,i)).finally(()=>{n===this.token&&e.settled?.();});}};var dl=1,cl=6603,ml=291807;function zt(t){return t===dl?cl:t<0?ml:t}function jt(t,o){return t.map(e=>{let n=o[e];return n?{id:e,icon:n.icon,name:n.name}:(ua$1("windowSpells: ability id missing from ability map",e),{id:e,icon:"",name:`Ability #${e}`})})}function pl(t,o,e,n,i,a=false){return a?{status:"info",icon:"insights"}:i?{status:"muted",icon:"schedule"}:t===null?{status:"muted",icon:"help_outline"}:t<e-n?{status:"bad",icon:"error"}:o>0&&t<o-n?{status:"warn",icon:"warning_amber"}:{status:"good",icon:"check_circle"}}function fl(t,o){let e=[],n=[];for(let i of t){let a=o[i];a?e.push(a):n.push(i);}return {spellIds:e,labels:n}}function ul(t,o,e){let n={};for(let i of o?.ability_breakdown??[])n[i.spell_id]=i;return t.map(i=>{let a=e[i.spell_id];return a||ua$1("burstDetailRows: ability id missing from ability map",i.spell_id),{spellId:i.spell_id,label:a?.name??`Ability #${i.spell_id}`,icon:a?.icon??"",playerPct:n[i.spell_id]?.damage??null,topAvg:i.avg_damage,topMin:i.min_damage,topMax:i.max_damage,playerCasts:n[i.spell_id]?.casts??null,topCasts:i.avg_casts??null,passive:i.is_passive??false}})}function hl(t){return {timeS:t.time_s,windowLengthS:t.window_length_s}}function _l(t,o){return {timeS:t.time_s,windowLengthS:t.window_length_s,key:`burst-${o}`}}function fn(t,o,e,n,i,a=false){let r=[],l=[],s=[];return t.forEach((m,f)=>{let h=m.time_s>e,x=h?null:o[f]??null,y=x?.window_damage??null,{status:w,icon:T}=pl(y,m.dmg_avg,m.dmg_min,m.dmg_stddev,h,a),{spellIds:z,labels:K}=fl(m.common_cds,n);r.push({timeStartS:m.time_s,timeEndS:m.time_s+m.window_length_s,spells:jt(z,i),labels:K,status:w,statusIcon:T,overview:{label:"",icon:"",playerPct:y,topAvg:m.dmg_avg,topMin:m.dmg_min,topMax:m.dmg_max},detailRows:ul(m.ability_breakdown,x,i)}),l.push(hl(m)),s.push(_l(m,f));}),{windows:r,anchors:l,clipAnchors:s}}function un(t){return (t.amount||0)+(t.absorbed||0)}function gl(t,o,e,n,i){let a=h=>h>=t.time_s&&h<t.time_s+t.window_length_s,r=o.filter(h=>a((h.timestamp-n)/1e3)),l=r.reduce((h,x)=>h+un(x),0),s={};for(let h of r){if(!h.abilityGameID)continue;let x=zt(h.abilityGameID);s[x]=(s[x]||0)+un(h);}let m=new Map;for(let h of e)if(a((h.timestamp-n)/1e3)){let x=i(h.abilityGameID);m.set(x,(m.get(x)??0)+1);}let f=Object.entries(s).sort((h,x)=>x[1]-h[1]).map(([h,x])=>{let y=parseInt(h,10);return {spell_id:y,damage:Math.round(x),casts:m.get(i(y))??0}});return {time_s:t.time_s,window_damage:Math.round(l),ability_breakdown:f}}function vl(t,o,e,n,i){let a=s=>i.get(s)??`Spell ${s}`,r=o.filter(s=>s.timestamp>=n&&un(s)>0).sort((s,m)=>s.timestamp-m.timestamp),l=e.filter(s=>s.type==="cast"&&s.abilityGameID);return t.map(s=>gl(s,r,l,n,a))}var ho=(()=>{class t{source=T(Ya$1);wclApi=T(ve);async loadPlayerView(e,n,i,a,r){let l=await this.source.getBench(e,n);if(!l.ok)return l;try{let s=await this.wclApi.getReport(i),m=s.fights.find(T=>T.id===a);if(!m)return ri(fn(l.value.windows,[],Number.POSITIVE_INFINITY,l.value.cd_spell_ids,l.value.ability_icons,!0));let f=new Map;for(let T of s.masterData?.abilities??[])f.set(T.gameID,T.name);let[h,x]=await Promise.all([this.wclApi.getAllEvents(i,a,"Casts",m.startTime,m.endTime,r),this.wclApi.getAllEvents(i,a,"DamageDone",m.startTime,m.endTime,r)]),y=vl(l.value.windows,x,h,m.startTime,f),w=(m.endTime-m.startTime)/1e3;return ri(fn(l.value.windows,y,w,l.value.cd_spell_ids,l.value.ability_icons))}catch(s){return ua$1(`BurstFeatureService.loadPlayerView ${i}:${a}`,s),ma$1(s,"burst.player-view")}}async loadBenchView(e,n){let i=await this.source.getBench(e,n);return i.ok?ri(fn(i.value.windows,[],Number.POSITIVE_INFINITY,i.value.cd_spell_ids,i.value.ability_icons,true)):i}static \u0275fac=function(n){return new(n||t)};static \u0275prov=oe({token:t,factory:t.\u0275fac,providedIn:"root"})}return t})();function xl(t,o){if(t&1&&np(0,"wl-load-state",0),t&2){let e=_E();tp("error",e.error());}}function bl(t,o){if(t&1){let e=vE();oi$1(0,"wl-window-comparison",2),cp("openMap",function(i){tu(e);let a=_E();return nu(a.onOpenMap(i))})("openClip",function(i){tu(e);let a=_E();return nu(a.onOpenClip(i))}),bc();}if(t&2){let e=_E();tp("windows",e.windows())("higherIsBetter",true)("showMap",e.showMap())("showClip",e.showClip());}}var mf=(()=>{class t{burst=T(ho);spec=iF.required();encounterId=iF.required();report=iF("");fight=iF(0);player=iF(0);showMap=iF(false);showClip=iF(false);openMap=oF();openClip=oF();busyChange=oF();availableChange=oF();available=So$1(true);error=So$1(null);_windows=So$1([]);_anchors=So$1([]);_clipAnchors=So$1([]);windows=this._windows.asReadonly();loader=new Je;constructor(){Cu(()=>{let e=this.spec(),n=this.encounterId(),i=this.report(),a=this.fight(),r=this.player(),l=i&&a&&r?this.burst.loadPlayerView(e,n,i,a,r):this.burst.loadBenchView(e,n);this.loader.run(l,{context:"burst.loadPlayerView",apply:s=>{s.ok?(this.error.set(null),this.available.set(true),this.availableChange.emit(true),this._windows.set(s.value.windows),this._anchors.set(s.value.anchors),this._clipAnchors.set(s.value.clipAnchors)):(s.error.kind==="permanent"&&ua$1(s.error.id,s.error.context),this.error.set(s.error.kind==="missing"?null:s.error),this.available.set(false),this.availableChange.emit(false),this._windows.set([]),this._anchors.set([]),this._clipAnchors.set([]));},settled:()=>this.busyChange.emit(false)});});}onOpenMap(e){let n=this._anchors()[e];n&&this.openMap.emit(n);}onOpenClip(e){let n=this._clipAnchors()[e];n&&this.openClip.emit(n);}static \u0275fac=function(n){return new(n||t)};static \u0275cmp=jI({type:t,selectors:[["wl-burst-windows"]],inputs:{spec:[1,"spec"],encounterId:[1,"encounterId"],report:[1,"report"],fight:[1,"fight"],player:[1,"player"],showMap:[1,"showMap"],showClip:[1,"showClip"]},outputs:{openMap:"openMap",openClip:"openClip",busyChange:"busyChange",availableChange:"availableChange"},decls:2,vars:1,consts:[["heading","Burst Windows","subtitle","Damage in each burst window vs top parses.",3,"error"],["heading","Burst Windows","subtitle","Damage in each burst window vs top parses.",3,"windows","higherIsBetter","showMap","showClip"],["heading","Burst Windows","subtitle","Damage in each burst window vs top parses.",3,"openMap","openClip","windows","higherIsBetter","showMap","showClip"]],template:function(n,i){n&1&&aE(0,xl,1,1,"wl-load-state",0)(1,bl,1,4,"wl-window-comparison",1),n&2&&cE(i.error()||!i.available()?0:1);},dependencies:[uo,Xe],encapsulation:2})}return t})();var yl=["content"],wl=["*"];function Cl(t,o){if(t&1){let e=vE();oi$1(0,"button",3),cp("click",function(){tu(e);let i=_E();return nu(i.toggle())}),nD(1),oi$1(2,"mat-icon",4),nD(3),bc()();}if(t&2){let e=_E();ep("aria-expanded",e.expanded()),ov(),xc(" ",e.expanded()?"Show less":"Show more"," "),ov(2),Cp(e.expanded()?"expand_less":"expand_more");}}var _o=(()=>{class t{destroyRef=T(Le$1);content=sF.required("content");expanded=So$1(false);overflowing=So$1(false);constructor(){Oy(()=>{let e=this.content().nativeElement,n=()=>{this.expanded()||this.overflowing.set(e.scrollHeight-e.clientHeight>1);};if(n(),typeof ResizeObserver<"u"){let i=new ResizeObserver(n);i.observe(e),this.destroyRef.onDestroy(()=>i.disconnect());}});}toggle(){this.expanded.update(e=>!e);}static \u0275fac=function(n){return new(n||t)};static \u0275cmp=jI({type:t,selectors:[["wl-collapsible-text"]],viewQuery:function(n,i){n&1&&pp(i.content,yl,5),n&2&&kE();},hostAttrs:[1,"block"],ngContentSelectors:wl,decls:4,vars:3,consts:[["content",""],[1,"md:line-clamp-none"],["type","button",1,"md:hidden","mt-1.5","inline-flex","items-center","gap-0.5","text-[11.5px]","text-[var(--accent)]"],["type","button",1,"md:hidden","mt-1.5","inline-flex","items-center","gap-0.5","text-[11.5px]","text-[var(--accent)]",3,"click"],[1,"icon-16"]],template:function(n,i){n&1&&(SE(),oi$1(0,"div",1,0),NE(2),bc(),aE(3,Cl,4,3,"button",2)),n&2&&(yp("line-clamp-2",!i.expanded()),ov(3),cE(i.overflowing()?3:-1));},dependencies:[hv,uv],encapsulation:2})}return t})();var Sl={0:"Head",1:"Neck",2:"Shoulder",3:"Shirt",4:"Chest",5:"Waist",6:"Legs",7:"Feet",8:"Wrists",9:"Hands",10:"Ring 1",11:"Ring 2",12:"Trinket 1",13:"Trinket 2",14:"Back",15:"Main Hand",16:"Off Hand"},Ml={ok:"check_circle",warn:"warning",info:"info",unknown:"help_outline"};function ct(t){return Sl[t]||`Slot ${t}`}function go(t){return Ml[t]}function vo(t,o){let e=o?.enchants??{},n=t.enchants??[];if(!Object.keys(e).length&&!n.length)return [];let i=new Set;for(let r of Object.keys(e))i.add(Number(r));for(let r of n)i.add(r.slot);let a=[];for(let r of [...i].sort((l,s)=>l-s)){let l=ct(r),s=e[r]?.[0],m=s?s.name||`Enchant #${s.id}`:"",f=n.find(y=>y.slot===r);if(!f){s&&s.pct>=50&&a.push({slotName:l,status:"warn",name:"Not enchanted",topPct:s.pct,note:`Apply ${m}`});continue}let h=f.name||`Enchant #${f.id}`,x=e[r]?.find(y=>y.id===f.id)?.pct??null;s&&f.id===s.id?a.push({slotName:l,status:"ok",name:h,topPct:s.pct,note:`${s.pct}% run this`}):s?a.push({slotName:l,status:"info",name:h,topPct:x,note:`${s.pct}% run ${m}`}):a.push({slotName:l,status:"ok",name:h,topPct:null,note:null});}return a}function xo(t){return t.some(o=>o.status==="warn")?"warn":"ok"}function hn(t,o){let e=t?.talent_builds??[];return e.length?e.map((n,i)=>({pct:n.pct,isPlayer:!!o&&n.key===o,link:`https://www.warcraftlogs.com/reports/${n.report_code}?fight=${n.fight_id}&type=summary&source=${n.source_id}`,playerName:n.player_name,label:i===0?"Most common build":`Alt build ${i}`})):[]}function _n(t,o){let e=t?.talent_builds??[];if(!e.length)return {status:"unknown",note:"No talent data."};let n=e[0]?.pct??0;return !o||o.split(":")[0]!==(e[0]?.key??"").split(":")[0]?{status:"ok",note:`${n}% run this build`}:e.some(i=>i.key===o)?{status:"ok",note:"Standard build."}:{status:"warn",note:`Off-meta build. ${n}% run the standard one.`}}function Dl(t,o){let e=t?.trinkets??{},n=0,i=false;for(let a of [12,13]){let r=(e[a]??[]).find(l=>l.id===o);r&&(n+=r.pct,i=true);}return i?n:null}function bo(t,o){let e=t.trinkets??[],n=wo(o),i=[],a=new Set(e.map(m=>m.id)),r=n.filter(m=>!a.has(m.id)),l=0,s=new Set;for(let m of [12,13]){let f=ct(m),h=e.find(w=>w.slot===m);if(!h){let w=r[l];if(!w)continue;l++,i.push({slotLabel:f,id:w.id,name:w.name,icon:w.icon,status:"info",topPct:w.pct,note:`${w.pct}% run this trinket`});continue}let x=n.find(w=>w.id===h.id&&!s.has(w.id));if(x){s.add(x.id),i.push({slotLabel:f,id:h.id,name:h.name,icon:h.icon??"",status:"ok",topPct:x.pct,note:null});continue}let y=r[l];y?(l++,i.push({slotLabel:f,id:h.id,name:h.name,icon:h.icon??"",status:"info",topPct:Dl(o,h.id),note:`Switch to ${y.name} (${y.pct}%)`})):i.push({slotLabel:f,id:h.id,name:h.name,icon:h.icon??"",status:"ok",topPct:null,note:null});}return i}function yo(t){return t.some(o=>o.status==="warn")?"warn":t.some(o=>o.status==="info")?"info":"ok"}function wo(t){let o=t?.trinkets??{},e=new Map;for(let n of [12,13])for(let i of o[n]??[]){let a=e.get(i.id);a?a.pct+=i.pct:e.set(i.id,{id:i.id,name:i.name,icon:i.icon,pct:i.pct});}return [...e.values()].sort((n,i)=>i.pct-n.pct).slice(0,2)}function Co(t){let o=t?.enchants??{};return Object.keys(o).map(Number).sort((e,n)=>e-n).reduce((e,n)=>{let i=o[n]?.[0];return i&&i.pct>=50&&e.push({slotName:ct(n),name:i.name||`Enchant #${i.id}`,pct:i.pct}),e},[])}function So(t){return wo(t).map((o,e)=>({slotLabel:e===0?"Trinket 1":"Trinket 2",id:o.id,name:o.name,icon:o.icon,pct:o.pct}))}function Mo(t,o){return t.find(e=>e.sourceID===o)??t[0]??null}var kl=[12,13];function Tl(t){return (t??"").replace(/\.jpg$/i,"")}function gn(t){return t.replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&#39;/g,"'")}function Do(t){if(!t?.length)return "";let o=t.filter(e=>e.nodeID!=null).map(e=>String(e.nodeID));return o.length?"v2:"+o.sort().join(","):""}function vn(t){let o=[],e=[];return (t??[]).forEach((n,i)=>{if(!n?.id)return;let a=typeof n.id=="string"?parseInt(n.id,10):n.id;kl.includes(i)&&o.push({slot:i,id:a,name:n.name??"",icon:Tl(n.icon)});let r=n.permanentEnchant;if(r){let l=typeof r=="string"?parseInt(r,10):r;e.push({slot:i,id:l,name:n.permanentEnchantName??""});}}),{trinkets:o,enchants:e}}function xn(){return {comparison:false,talentBuilds:[],talentStatus:{status:"unknown",note:"No talent data."},trinketRows:[],trinketStatus:"ok",benchTrinketRows:[],enchantRows:[],enchantStatus:"ok",benchEnchantRows:[]}}function El(t,o,e,n){if(!t?.gear?.length)return fa$1("No combatant info in this log.","gear.combatant-info");let{trinkets:i,enchants:a}=vn(t.gear),r=Do(t.talentTree);for(let l of i)!l.name&&l.id&&(l.name=gn(o[`i${l.id}`]?.name??""));for(let l of a)!l.name&&l.id&&(l.name=gn(o[`e${l.id}`]?.name??""));return ri({found:true,spec:n,source_report:e,talent_key:r,trinkets:i,enchants:a})}function ko(t){return {talent_builds:t.talent_builds,trinkets:t.trinkets,enchants:t.enchants}}function Il(t,o){let e=t.talent_key??"",n=vo(t,o),i=bo(t,o);return {comparison:true,talentBuilds:hn(o,e),talentStatus:_n(o,e),trinketRows:i,trinketStatus:yo(i),benchTrinketRows:[],enchantRows:n,enchantStatus:xo(n),benchEnchantRows:[]}}function Fl(t){return {comparison:false,talentBuilds:hn(t,""),talentStatus:_n(t,""),trinketRows:[],trinketStatus:"ok",benchTrinketRows:So(t),enchantRows:[],enchantStatus:"ok",benchEnchantRows:Co(t)}}var To=(()=>{class t{source=T(Ka$1);wclApi=T(ve);async loadComparisonView(e,n,i,a,r){let l=await this.source.getBench(e,n);if(!l.ok)return l;let s=await this.fetchPlayerGear(i,a,r,e);return s.ok?ri(Il(s.value,ko(l.value))):s}async loadBenchView(e,n){let i=await this.source.getBench(e,n);return i.ok?ri(Fl(ko(i.value))):i}async fetchPlayerGear(e,n,i,a){try{let r=Mo(await this.wclApi.getCombatantInfo(e,n,i),i),l={};if(r?.gear?.length){let{trinkets:s,enchants:m}=vn(r.gear),f=[...new Set(s.filter(x=>x.id).map(x=>x.id))],h=[...new Set(m.filter(x=>x.id).map(x=>x.id))];try{l=await this.wclApi.getGameNames(f,h);}catch(x){ua$1(`GearFeatureService name resolution ${e}:${n}:${i}`,x);}}return El(r,l,e,a)}catch(r){return ua$1(`GearFeatureService player gear ${e}:${n}:${i}`,r),ma$1(r,"gear.player-view")}}static \u0275fac=function(n){return new(n||t)};static \u0275prov=oe({token:t,factory:t.\u0275fac,providedIn:"root"})}return t})();var Ol=(t,o)=>o.label,bn=(t,o)=>o.slotLabel,Eo=(t,o)=>o.slotName;function Al(t,o){if(t&1&&np(0,"wl-load-state",0),t&2){let e=_E();tp("error",e.error());}}function Rl(t,o){t&1&&(oi$1(0,"div",5),nD(1,"Gear vs top parses."),bc());}function Pl(t,o){t&1&&(oi$1(0,"div",5),nD(1,"Top-parse gear consensus."),bc());}function Nl(t,o){t&1&&(oi$1(0,"div",18),nD(1),bc()),t&2&&(ov(),xc("",o.pct,"% run the standard build"));}function Ll(t,o){t&1&&(oi$1(0,"a",23),nD(1,"View parse \u2197"),bc()),t&2&&tp("href",o,Qd);}function $l(t,o){if(t&1&&(oi$1(0,"div",11)(1,"div",14)(2,"mat-icon",15),nD(3,"warning_amber"),bc()(),oi$1(4,"div",16)(5,"span",17),nD(6,"Off-meta build"),bc(),aE(7,Nl,2,1,"div",18),bc(),np(8,"div",19),oi$1(9,"div",20)(10,"span",21),nD(11,"Fix"),bc(),oi$1(12,"div",22)(13,"span"),nD(14,"Switch to the standard build."),bc(),aE(15,Ll,2,1,"a",23),bc()()()),t&2){let e,n,i=_E(3);ov(7),cE((e=i.view().talentBuilds[0])?7:-1,e),ov(8),cE((n=i.view().talentBuilds[0]?.link)?15:-1,n);}}function Bl(t,o){t&1&&(oi$1(0,"div",12)(1,"span",24),nD(2,"On plan"),bc(),oi$1(3,"span",25)(4,"span",26),nD(5,"Most common build"),bc()()());}function Wl(t,o){t&1&&(oi$1(0,"div",13),nD(1," No talent data. "),bc());}function zl(t,o){if(t&1&&aE(0,$l,16,2,"div",11)(1,Bl,6,0,"div",12)(2,Wl,2,0,"div",13),t&2){let e=_E(2);cE(e.view().talentStatus.status==="warn"?0:e.view().talentStatus.status==="ok"?1:2);}}function jl(t,o){if(t&1&&(oi$1(0,"div",27),np(1,"div",19),oi$1(2,"div",28),nD(3),bc(),oi$1(4,"div",29)(5,"div",30),nD(6),bc(),oi$1(7,"div",31),nD(8,"of top parsers"),bc()(),oi$1(9,"div",32)(10,"a",23),nD(11,"View parse \u2197"),bc()()()),t&2){let e=o.$implicit;ov(3),Cp(e.label),ov(3),xc("",e.pct,"%"),ov(4),tp("href",e.link,Qd);}}function Gl(t,o){if(t&1&&dE(0,jl,12,3,"div",27,Ol),t&2){let e=_E(3);fE(e.view().talentBuilds);}}function Vl(t,o){t&1&&(oi$1(0,"div",13),nD(1," No talent data. "),bc());}function ql(t,o){if(t&1&&aE(0,Gl,2,0)(1,Vl,2,0,"div",13),t&2){let e=_E(2);cE(e.view().talentBuilds.length?0:1);}}function Hl(t,o){if(t&1&&(oi$1(0,"span",38),nD(1,"Measured"),bc(),oi$1(2,"div",30),nD(3),bc(),oi$1(4,"div",39),nD(5,"of top parsers"),bc()),t&2){let e=_E(2).$implicit;ov(3),xc("",e.topPct,"%");}}function Ul(t,o){if(t&1&&(oi$1(0,"div",11)(1,"div",14)(2,"mat-icon",34),nD(3),bc()(),oi$1(4,"div",16),np(5,"wl-game-icon",35),oi$1(6,"div",36),nD(7),bc()(),oi$1(8,"div",37),aE(9,Hl,6,1),bc(),oi$1(10,"div",20)(11,"span",21),nD(12,"Fix"),bc(),oi$1(13,"wl-collapsible-text"),nD(14),bc()()()),t&2){let e=_E().$implicit;ov(2),yp("badge-warning",e.status==="warn")("badge-info",e.status==="info"),ov(),xc(" ",e.status==="info"?"info":"warning_amber"," "),ov(2),tp("id",e.id)("name",e.name)("icon",e.icon),ov(2),Cp(e.slotLabel),ov(),yp("badge-warning",e.status==="warn")("badge-info",e.status==="info"),ov(),cE(e.topPct!==null?9:-1),ov(5),Cp(e.note);}}function Ql(t,o){if(t&1&&(oi$1(0,"span",38),nD(1,"Measured"),bc(),oi$1(2,"div",42),nD(3),bc(),oi$1(4,"div",39),nD(5,"of top parsers"),bc()),t&2){let e=_E(2).$implicit;ov(3),xc("",e.topPct,"%");}}function Kl(t,o){if(t&1&&(oi$1(0,"div",33)(1,"div",14),np(2,"span",40),bc(),oi$1(3,"div",16),np(4,"wl-game-icon",35),oi$1(5,"div",36),nD(6),bc()(),oi$1(7,"div",41),aE(8,Ql,6,1),bc(),np(9,"div",19),bc()),t&2){let e=_E().$implicit;ov(4),tp("id",e.id)("name",e.name)("icon",e.icon),ov(2),Cp(e.slotLabel),ov(2),cE(e.topPct!==null?8:-1);}}function Yl(t,o){if(t&1&&aE(0,Ul,15,15,"div",11)(1,Kl,10,5,"div",33),t&2){let e=o.$implicit;cE(e.status!=="ok"?0:1);}}function Xl(t,o){if(t&1&&dE(0,Yl,2,1,null,null,bn),t&2){let e=_E(3);fE(e.view().trinketRows);}}function Zl(t,o){if(t&1&&(oi$1(0,"span",25),np(1,"wl-game-icon",35),bc()),t&2){let e=o.$implicit;ov(),tp("id",e.id)("name",e.name)("icon",e.icon);}}function Jl(t,o){if(t&1&&(oi$1(0,"div",12)(1,"span",24),nD(2,"On plan"),bc(),dE(3,Zl,2,3,"span",25,bn),bc()),t&2){let e=_E(3);ov(3),fE(e.view().trinketRows);}}function es(t,o){t&1&&(oi$1(0,"div",13),nD(1," No trinket data. "),bc());}function ts(t,o){if(t&1&&aE(0,Xl,2,0)(1,Jl,5,0,"div",12)(2,es,2,0,"div",13),t&2){let e=_E(2);cE(e.view().trinketStatus!=="ok"?0:e.view().trinketRows.length?1:2);}}function ns(t,o){if(t&1&&(oi$1(0,"div",27),np(1,"div",19),oi$1(2,"div",16),np(3,"wl-game-icon",35),oi$1(4,"div",36),nD(5),bc()(),oi$1(6,"div",29)(7,"div",30),nD(8),bc(),oi$1(9,"div",31),nD(10,"of top parsers"),bc()(),np(11,"div",19),bc()),t&2){let e=o.$implicit;ov(3),tp("id",e.id)("name",e.name)("icon",e.icon),ov(2),Cp(e.slotLabel),ov(3),xc("",e.pct,"%");}}function is(t,o){if(t&1&&dE(0,ns,12,5,"div",27,bn),t&2){let e=_E(3);fE(e.view().benchTrinketRows);}}function os(t,o){t&1&&(oi$1(0,"div",13),nD(1," No trinket data. "),bc());}function as(t,o){if(t&1&&aE(0,is,2,0)(1,os,2,0,"div",13),t&2){let e=_E(2);cE(e.view().benchTrinketRows.length?0:1);}}function rs(t,o){if(t&1&&(oi$1(0,"span",38),nD(1,"Measured"),bc(),oi$1(2,"div",30),nD(3),bc(),oi$1(4,"div",39),nD(5,"of top parsers"),bc()),t&2){let e=_E().$implicit;ov(3),xc("",e.topPct,"%");}}function ls(t,o){if(t&1&&(oi$1(0,"div",11)(1,"div",14)(2,"mat-icon",34),nD(3),bc()(),oi$1(4,"div",43)(5,"span",44),nD(6),bc(),oi$1(7,"span",45),nD(8),bc()(),oi$1(9,"div",37),aE(10,rs,6,1),bc(),oi$1(11,"div",20)(12,"span",21),nD(13,"Fix"),bc(),oi$1(14,"wl-collapsible-text"),nD(15),bc()()()),t&2){let e=o.$implicit;ov(2),yp("badge-warning",e.status==="warn")("badge-info",e.status==="info"),ov(),xc(" ",e.status==="info"?"info":"warning_amber"," "),ov(3),Cp(e.slotName),ov(2),Cp(e.name),ov(),yp("badge-warning",e.status==="warn")("badge-info",e.status==="info"),ov(),cE(e.topPct!==null?10:-1),ov(5),Cp(e.note);}}function ss(t,o){if(t&1&&(oi$1(0,"div",12)(1,"span",24),nD(2,"On plan"),bc(),oi$1(3,"span",25)(4,"span",26),nD(5),bc()()()),t&2){let e=_E(4);ov(5),xc("",e.enchantOnPlan().length," enchants");}}function ds(t,o){if(t&1&&(dE(0,ls,16,13,"div",11,Eo),aE(2,ss,6,1,"div",12)),t&2){let e=_E(3);fE(e.enchantIssues()),ov(2),cE(e.enchantOnPlan().length?2:-1);}}function cs(t,o){t&1&&(oi$1(0,"div",12)(1,"span",24),nD(2,"On plan"),bc(),oi$1(3,"span",25)(4,"span",26),nD(5,"All enchants"),bc()()());}function ms(t,o){t&1&&(oi$1(0,"div",13),nD(1," No enchant data. "),bc());}function ps(t,o){if(t&1&&aE(0,ds,3,1)(1,cs,6,0,"div",12)(2,ms,2,0,"div",13),t&2){let e=_E(2);cE(e.enchantIssues().length?0:e.view().enchantRows.length?1:2);}}function fs(t,o){if(t&1&&(oi$1(0,"div",27),np(1,"div",19),oi$1(2,"div",43)(3,"span",44),nD(4),bc(),oi$1(5,"span",17),nD(6),bc()(),oi$1(7,"div",29)(8,"div",30),nD(9),bc(),oi$1(10,"div",31),nD(11,"of top parsers"),bc()(),np(12,"div",19),bc()),t&2){let e=o.$implicit;ov(4),Cp(e.slotName),ov(2),Cp(e.name),ov(3),xc("",e.pct,"%");}}function us(t,o){if(t&1&&dE(0,fs,13,3,"div",27,Eo),t&2){let e=_E(3);fE(e.view().benchEnchantRows);}}function hs(t,o){t&1&&(oi$1(0,"div",13),nD(1," No enchant data. "),bc());}function _s(t,o){if(t&1&&aE(0,us,2,0)(1,hs,2,0,"div",13),t&2){let e=_E(2);cE(e.view().benchEnchantRows.length?0:1);}}function gs(t,o){if(t&1&&(oi$1(0,"div",1)(1,"div",2)(2,"div",3)(3,"div",4),nD(4,"Gear"),bc(),aE(5,Rl,2,0,"div",5)(6,Pl,2,0,"div",5),bc(),oi$1(7,"div",6),nD(8,"Measured"),bc(),oi$1(9,"div",7),nD(10,"Fix"),bc()(),oi$1(11,"div",8)(12,"div",9),np(13,"div"),oi$1(14,"div",10),nD(15,"Talents"),bc(),np(16,"div")(17,"div"),bc(),aE(18,zl,3,1)(19,ql,2,1),bc(),oi$1(20,"div",8)(21,"div",9),np(22,"div"),oi$1(23,"div",10),nD(24,"Trinkets"),bc(),np(25,"div")(26,"div"),bc(),aE(27,ts,3,1)(28,as,2,1),bc(),oi$1(29,"div",8)(30,"div",9),np(31,"div"),oi$1(32,"div",10),nD(33,"Enchants"),bc(),np(34,"div")(35,"div"),bc(),aE(36,ps,3,1)(37,_s,2,1),bc()()),t&2){let e=_E();ov(5),cE(e.view().comparison?5:6),ov(13),cE(e.view().comparison?18:19),ov(9),cE(e.view().comparison?27:28),ov(9),cE(e.view().comparison?36:37);}}var zf=(()=>{class t{gear=T(To);spec=iF.required();encounterId=iF.required();report=iF("");fight=iF(0);player=iF(0);busyChange=oF();availableChange=oF();_view=So$1(xn());view=this._view.asReadonly();_available=So$1(false);available=this._available.asReadonly();_error=So$1(null);error=this._error.asReadonly();enchantIssues=TD(()=>this.view().enchantRows.filter(e=>e.status!=="ok"));enchantOnPlan=TD(()=>this.view().enchantRows.filter(e=>e.status==="ok"));slotName=ct;statusIcon=go;loader=new Je;constructor(){Cu(()=>{let e=this.spec(),n=this.encounterId(),i=this.report(),a=this.fight(),r=this.player(),l=i&&a&&r?this.gear.loadComparisonView(e,n,i,a,r):this.gear.loadBenchView(e,n);this.loader.run(l,{context:"gear.load",apply:s=>{s.ok?(this._error.set(null),this._view.set(s.value),this._available.set(true),this.availableChange.emit(true)):(s.error.kind==="permanent"&&ua$1(s.error.id,s.error.context),this._error.set(s.error.kind==="missing"?null:s.error),this._view.set(xn()),this._available.set(false),this.availableChange.emit(false));},settled:()=>this.busyChange.emit(false)});});}static \u0275fac=function(n){return new(n||t)};static \u0275cmp=jI({type:t,selectors:[["wl-gear"]],inputs:{spec:[1,"spec"],encounterId:[1,"encounterId"],report:[1,"report"],fight:[1,"fight"],player:[1,"player"]},outputs:{busyChange:"busyChange",availableChange:"availableChange"},decls:2,vars:1,consts:[["heading","Gear","subtitle","Top-parse gear consensus.",3,"error"],[1,"bg-[var(--surface)]","border","border-[var(--border)]","rounded-[10px]","overflow-hidden"],[1,"px-4","pt-3","pb-2","md:grid","md:grid-cols-[20px_minmax(0,1fr)_96px_200px]","md:gap-[14px]","md:items-baseline"],[1,"md:col-span-2"],[1,"text-[17px]","font-semibold","text-[var(--text)]"],[1,"text-xs","text-[var(--muted)]","mt-0.5"],[1,"hidden","md:block","text-[10px]","uppercase","tracking-widest","text-[var(--muted)]","text-right"],[1,"hidden","md:block","text-[10px]","uppercase","tracking-widest","text-[var(--muted)]","pl-[14px]"],[1,"border-t","border-[var(--border)]"],[1,"px-4","pt-3","pb-1","md:grid","md:grid-cols-[20px_minmax(0,1fr)_96px_200px]","md:gap-[14px]","md:items-baseline"],[1,"text-[10px]","uppercase","tracking-widest","text-[var(--muted)]"],[1,"grid","grid-cols-[20px_minmax(0,1fr)]","md:grid-cols-[20px_minmax(0,1fr)_96px_200px]","gap-x-[14px]","gap-y-2","md:gap-y-0","px-4","py-[10px]","items-start","md:items-center","border-t","border-[var(--border)]"],[1,"flex","items-center","gap-2","flex-wrap","border-t","border-[var(--border)]","px-4","py-[10px]"],[1,"flex","items-center","gap-2","border-t","border-[var(--border)]","px-4","py-3","text-[13px]","text-[var(--muted)]"],[1,"flex","items-center","justify-center","self-start","md:self-center"],[1,"icon-18","badge-warning"],[1,"min-w-0"],[1,"text-sm","text-[var(--text)]"],[1,"text-[10px]","text-[var(--muted)]","mt-0.5"],[1,"hidden","md:block"],[1,"col-start-2","md:col-auto","text-[13px]","text-[var(--muted)]","leading-[1.45]","border-t","md:border-t-0","md:border-l","border-[var(--border)]","pt-2","md:pt-0","pl-0","md:pl-[14px]"],[1,"md:hidden","block","font-mono","text-[10px]","uppercase","tracking-wider","text-[var(--muted)]","mb-1"],[1,"flex","flex-wrap","items-center","gap-2"],["target","_blank","rel","noopener",1,"rounded-[3px]","border","border-[var(--accent)]/20","bg-[var(--accent)]/[0.08]","px-[7px]","py-[1px]","font-mono","text-[10px]","text-[var(--accent)]","no-underline","whitespace-nowrap","hover:brightness-125",3,"href"],[1,"text-[10px]","uppercase","tracking-widest","text-[var(--muted)]","mr-0.5"],[1,"chip-onplan"],[1,"text-[13px]","text-[var(--muted)]"],[1,"grid","grid-cols-[minmax(0,1fr)_auto]","md:grid-cols-[20px_minmax(0,1fr)_96px_200px]","gap-x-[14px]","gap-y-1","md:gap-y-0","items-center","px-4","py-[10px]","border-t","border-[var(--border)]"],[1,"min-w-0","text-sm","text-[var(--text)]"],[1,"text-right","leading-[1.1]","text-[var(--muted)]"],[1,"text-[15px]","font-semibold","tabular-nums"],[1,"text-[10px]","opacity-60","mt-px","tabular-nums"],[1,"col-start-2","md:col-auto","text-right","md:text-left","text-[13px]","text-[var(--muted)]","leading-[1.45]","md:border-l","md:border-[var(--border)]","md:pl-[14px]"],[1,"grid","grid-cols-[20px_minmax(0,1fr)]","md:grid-cols-[20px_minmax(0,1fr)_96px_200px]","gap-x-[14px]","gap-y-2","md:gap-y-0","px-4","py-[7px]","items-start","md:items-center","border-t","border-[var(--border)]/30","opacity-55"],[1,"icon-18"],["kind","item",3,"id","name","icon"],[1,"text-[11px]","text-[var(--muted)]","mt-0.5"],[1,"col-start-2","md:col-auto","flex","items-baseline","gap-2","md:block","text-left","md:text-right","leading-[1.1]"],[1,"md:hidden","font-mono","text-[10px]","uppercase","tracking-wider","text-[var(--muted)]"],[1,"text-[12px]","text-[var(--muted)]","md:text-inherit","md:text-[10px]","md:opacity-60","md:mt-px","tabular-nums"],[1,"block","h-[7px]","w-[7px]","shrink-0","rounded-full","bg-[var(--success)]/60"],[1,"col-start-2","md:col-auto","flex","items-baseline","gap-2","md:block","text-left","md:text-right","leading-[1.1]","text-[var(--success)]"],[1,"text-[14px]","font-semibold","tabular-nums"],[1,"min-w-0","flex","items-baseline","gap-2"],[1,"shrink-0","w-20","whitespace-nowrap","text-[10px]","uppercase","tracking-widest","text-[var(--muted)]"],[1,"text-sm","text-[var(--text)]","truncate"]],template:function(n,i){n&1&&aE(0,Al,1,1,"wl-load-state",0)(1,gs,38,4,"div",1),n&2&&cE(i.error()||!i.available()?0:1);},dependencies:[hv,uv,Ze,_o,Xe],encapsulation:2})}return t})();function Io(t){return typeof t.x!="number"||typeof t.y!="number"?null:t.resourceActor===2?t.targetID??null:t.sourceID??null}var Oo=-Math.PI/2,Fo=1/100,vs=1/1e3,Gt=5;function xs(t,o){let e=new Map;for(let i of t){let a=Io(i);if(a==null)continue;let r=e.get(a);r||(r=[],e.set(a,r)),r.push({t:(i.timestamp-o)/1e3,x:i.x*Fo,y:i.y*Fo,facing:typeof i.facing=="number"?i.facing*vs:void 0,mapID:typeof i.mapID=="number"?i.mapID:void 0});}let n=new Map;for(let[i,a]of e)a.sort((r,l)=>r.t-l.t),n.set(i,{id:i,samples:a});return n}function yn(t){let o=new Map;for(let e of t.parses)for(let n of e.enemies){if(n.game_id==null)continue;let i=o.get(n.game_id);i?n.is_boss&&(i.isBoss=true):o.set(n.game_id,{gameId:n.game_id,name:n.name,isBoss:n.is_boss});}return [...o.values()].sort((e,n)=>(n.isBoss?1:0)-(e.isBoss?1:0))}function bs(t,o){let e=new Map;for(let a of o)a.gameID!=null&&e.set(a.gameID,a.id);let n=yn(t).find(a=>a.isBoss)?.gameId;return {bossActorId:n!=null?e.get(n)??null:null,refActorByGameId:e}}function ys(t){let{positions:o,events:e,fightStartMs:n,playerId:i,enemies:a}=t,{bossActorId:r,refActorByGameId:l}=bs(o,a),s=xs(e,n);return s.get(i)?.samples.length?{timelines:s,playerId:i,bossActorId:r,refActorByGameId:l}:null}var Vt=(()=>{class t{source=T(qa);injector=T(ye);positions=So$1(null);live=So$1(null);error=So$1(null);overlayLoading=So$1(false);pendingOverlay=null;overlayLoaded=false;prepareSeq=0;open=So$1(false);anchorTime=So$1(0);reference=So$1({kind:"boss"});preS=So$1(Gt);postS=So$1(Gt);ready=TD(()=>!!this.positions());async loadBench(e,n){let i=await this.source.getBench(e,n);return this._applyBench(i),i}_applyBench(e){this.live.set(null),e.ok?(this.positions.set(e.value),this.error.set(null)):(e.error.kind==="permanent"&&ua$1(e.error.id,e.error.context),this.positions.set(null),this.error.set(e.error.kind==="missing"?null:e.error));}async prepare(e,n,i,a,r){let l=++this.prepareSeq;if(this.live.set(null),this._resetOverlay(),!n?.encounterID){this.positions.set(null),this.error.set(null);return}let s=await this.source.getBench(a,n.encounterID);l===this.prepareSeq&&(this._applyBench(s),s.ok&&(this.pendingOverlay={reportCode:e,fight:n,playerId:i,positions:s.value,enemies:r,seq:l},this.open()&&await this.ensureLiveOverlay()));}openAt(e){this.anchorTime.set(e.timeS),this.reference.set(e.reference??{kind:"boss"});let n=(e.windowLengthS??0)>0;this.preS.set(n?0:Gt),this.postS.set(n?e.windowLengthS:Gt),this.open.set(true),this.ensureLiveOverlay();}close(){this.open.set(false);}clear(){this.open.set(false),this.positions.set(null),this.live.set(null),this.error.set(null),this._resetOverlay();}_resetOverlay(){this.pendingOverlay=null,this.overlayLoaded=false,this.overlayLoading.set(false);}async ensureLiveOverlay(){let e=this.pendingOverlay;if(!(!e||this.overlayLoaded||this.overlayLoading())){this.overlayLoading.set(true);try{let{reportCode:n,fight:i,playerId:a,positions:r,enemies:l}=e,s=await this.fetchLiveEvents(n,i,a);if(e.seq!==this.prepareSeq)return;let m=ys({positions:r,events:s,fightStartMs:i.startTime,playerId:a,enemies:l});if(this.live.set(m),m)this.error.set(null);else {let f=fa$1("No position data for you in this pull.","map.no-player-positions");!f.ok&&f.error.kind==="permanent"&&(ua$1(f.error.id,f.error.context),this.error.set(f.error));}this.overlayLoaded=!0;}catch(n){let i=ma$1(n,"map.overlay");ua$1(`MapFeatureService.ensureLiveOverlay ${e.reportCode}:${e.fight.id}`,n),this.live.set(null),this.error.set(!i.ok&&i.error.kind!=="missing"?i.error:null);}finally{this.overlayLoading.set(false);}}}async fetchLiveEvents(e,n,i){let{id:a,startTime:r,endTime:l}=n,s=this.injector.get(ve),[m,f]=await Promise.all([s.getAllEvents(e,a,"Casts",r,l,i,true),s.getAllEvents(e,a,"Casts",r,l,void 0,true,"Enemies")]);return [...m,...f]}static \u0275fac=function(n){return new(n||t)};static \u0275prov=oe({token:t,factory:t.\u0275fac,providedIn:"root"})}return t})();var ws=["*"];function Cs(t,o){if(t&1&&(oi$1(0,"span",4),nD(1),bc()),t&2){let e=_E();ov(),Cp(e.loadingText());}}var Ao=(()=>{class t{heading=iF.required();loadingText=iF("");closeLabel=iF.required();closed=oF();static \u0275fac=function(n){return new(n||t)};static \u0275cmp=jI({type:t,selectors:[["wl-flyover-panel"]],inputs:{heading:[1,"heading"],loadingText:[1,"loadingText"],closeLabel:[1,"closeLabel"]},outputs:{closed:"closed"},ngContentSelectors:ws,decls:11,vars:3,consts:[[1,"fixed","inset-0","z-50","flex","flex-col","bg-[var(--bg)]","md:inset-y-0","md:left-auto","md:right-0","md:w-[460px]","md:border-l","md:border-[var(--border)]","md:shadow-2xl"],[1,"flex","items-center","justify-between","border-b","border-[var(--border)]","px-4","py-2"],[1,"flex","items-center","gap-2"],[1,"font-semibold"],[1,"text-[13px]","text-[var(--muted)]"],["mat-icon-button","",3,"click"],[1,"flex-1","overflow-y-auto","p-4"]],template:function(n,i){n&1&&(SE(),oi$1(0,"div",0)(1,"div",1)(2,"div",2)(3,"span",3),nD(4),bc(),aE(5,Cs,2,1,"span",4),bc(),oi$1(6,"button",5),cp("click",function(){return i.closed.emit()}),oi$1(7,"mat-icon"),nD(8,"close"),bc()()(),oi$1(9,"div",6),NE(10),bc()()),n&2&&(ov(4),Cp(i.heading()),ov(),cE(i.loadingText()?5:-1),ov(),ep("aria-label",i.closeLabel()));},dependencies:[xb,Hd,hv,uv],encapsulation:2})}return t})();var qt=1/100,Ss=1/1e3;function Ms(t,o){let e=(o-t)%(2*Math.PI);return e>Math.PI&&(e-=2*Math.PI),e<=-Math.PI&&(e+=2*Math.PI),e}function wn(t,o){return t.mapID==null||o.mapID==null||t.mapID===o.mapID}function Se(t,o,e=3){let n=t?.samples;if(!n||!n.length)return null;if(o<=n[0].t)return o<n[0].t-e?null:U($({},n[0]),{t:o});let i=n[n.length-1];if(o>=i.t)return o>i.t+e?null:U($({},i),{t:o});let a=0,r=n.length-1;for(;a<r;){let x=a+r>>1;n[x].t<o?a=x+1:r=x;}let l=n[a],s=n[a-1],m=l.t-s.t,f=m>0?(o-s.t)/m:0;if(s.mapID!==l.mapID)return U($({},f<.5?s:l),{t:o});let h;return s.facing!=null&&l.facing!=null?h=s.facing+Ms(s.facing,l.facing)*f:h=s.facing??l.facing,{t:o,x:s.x+(l.x-s.x)*f,y:s.y+(l.y-s.y)*f,facing:h,mapID:s.mapID}}function mt(t,o,e=0){let n=t.x-o.x,i=t.y-o.y,a=(o.facing??Math.PI/2)+Oo,r=Math.cos(a),l=Math.sin(a),s=n*r+i*l,m=n*l-i*r,f=Math.hypot(n,i),h=Math.atan2(m,s)*180/Math.PI;return {t:e,fwd:s,right:m,dist:f,angleDeg:h,mapID:t.mapID}}function Ds(t,o){let e=o.map(([n,i,a,r,l])=>({t:n,x:i*qt,y:a*qt,facing:r==null?void 0:r*Ss,mapID:l??void 0}));return {id:t,samples:e}}function ks(t,o){let e=o.map(([n,i,a,r])=>({t:n,x:i*qt,y:a*qt,mapID:r??void 0}));return {id:t,samples:e}}function Ts(t,o){return o.kind==="boss"?(t.enemies.find(n=>n.is_boss)??t.enemies[0])?.samples??null:t.enemies.find(e=>e.game_id===o.gameId)?.samples??null}function Ro(t,o){let e=[];for(let n of t.parses){let i=Ts(n,o);i&&e.push({player:ks(-1,n.player),ref:Ds(-2,i)});}return e}function Cn(t,o){let e=[];for(let{player:n,ref:i}of t){let a=Se(i,o),r=Se(n,o);a&&r&&wn(r,a)&&e.push(mt(r,a,o));}return e}function Po(t,o,e,n,i){let a=[];for(let{player:r,ref:l}of t){let s=[];for(let m=o-e;m<=o+n+1e-6;m+=i){let f=Se(l,m),h=Se(r,m);f&&h&&wn(h,f)&&s.push(mt(h,f,m));}s.length&&a.push(s);}return a}function No(t,o,e,n,i,a,r){let l=[],s=e.get(o),m=e.get(t);for(let f=n-i;f<=n+a+1e-6;f+=r){let h=Se(s,f),x=Se(m,f);h&&x&&wn(x,h)&&l.push(mt(x,h,f));}return l}var Es=["canvas"],Is=(t,o)=>o.gameId;function Fs(t,o){t&1&&np(0,"wl-load-state",1),t&2&&tp("error",o);}function Os(t,o){t&1&&(oi$1(0,"p",2),nD(1," No position data for this encounter. "),bc());}function As(t,o){if(t&1&&(oi$1(0,"mat-option",19),nD(1),bc()),t&2){let e=_E().$implicit;tp("value",e.gameId),ov(),Cp(e.name);}}function Rs(t,o){if(t&1&&aE(0,As,2,2,"mat-option",19),t&2){let e=o.$implicit;cE(e.isBoss?-1:0);}}function Ps(t,o){t&1&&(oi$1(0,"span",10),nD(1,"\u25C6 you"),bc());}function Ns(t,o){if(t&1){let e=vE();oi$1(0,"div",3)(1,"mat-form-field",4)(2,"mat-label"),nD(3,"Reference"),bc(),oi$1(4,"mat-select",5),cp("selectionChange",function(i){tu(e);let a=_E();return nu(a.onRefChange(i.value))}),oi$1(5,"mat-option",6),nD(6,"Boss"),bc(),dE(7,Rs,1,1,null,null,Is),bc()()(),oi$1(9,"div",7),np(10,"canvas",8,0),oi$1(12,"div",9),aE(13,Ps,2,0,"span",10),oi$1(14,"span",11),nD(15,"\u25CF top parses"),bc(),oi$1(16,"span",12),nD(17,"\u25EF top-parse centre"),bc(),oi$1(18,"span",13),nD(19,"\u25B2 reference (facing up)"),bc()()(),oi$1(20,"div",14)(21,"button",15),cp("click",function(){tu(e);let i=_E();return nu(i.togglePlay())}),oi$1(22,"mat-icon"),nD(23),bc()(),oi$1(24,"div",16)(25,"input",17),cp("input",function(i){tu(e);let a=_E();return nu(a.onScrub(i.target.valueAsNumber))}),bc(),oi$1(26,"div",18)(27,"span"),nD(28),mD(29,"formatDuration"),bc(),oi$1(30,"span"),nD(31),mD(32,"formatDuration"),bc(),oi$1(33,"span"),nD(34),mD(35,"formatDuration"),bc()()()();}if(t&2){let e=_E();ov(4),tp("value",e.refValue()),ov(3),fE(e.refEnemies()),ov(6),cE(e.live()?13:-1),ov(8),ep("aria-label",e.playing()?"Pause":"Play"),ov(2),Cp(e.playing()?"pause":"play_arrow"),ov(2),tp("min",e.windowStart())("max",e.windowEnd())("value",e.scrubT()),ov(3),Cp(vD(29,10,e.windowStart())),ov(3),xc("anchor ",vD(32,12,e.anchorTime())),ov(3),Cp(vD(35,14,e.windowEnd()));}}var Lo=.5,Ls=.1,$o=(()=>{class t{map=T(Vt);positions=this.map.positions;live=this.map.live;anchorTime=this.map.anchorTime;loadError=TD(()=>{let e=this.map.error();return e&&e.kind!=="missing"?e:null});selector=So$1({kind:"boss"});scrubT=So$1(0);playing=So$1(false);rafId=null;lastFrameMs=0;canvas=sF("canvas");refEnemies=TD(()=>{let e=this.positions();return e?yn(e):[]});refValue=TD(()=>{let e=this.selector();return e.kind==="boss"?"boss":e.gameId});preS=this.map.preS;postS=this.map.postS;windowStart=TD(()=>this.anchorTime()-this.preS());windowEnd=TD(()=>this.anchorTime()+this.postS());parseTimelines=TD(()=>{let e=this.positions();return e?Ro(e,this.selector()):[]});benchTrails=TD(()=>Po(this.parseTimelines(),this.anchorTime(),this.preS(),this.postS(),Lo));liveRefId=TD(()=>{let e=this.live();if(!e)return null;let n=this.selector();return n.kind==="boss"?e.bossActorId:e.refActorByGameId.get(n.gameId)??null});liveTrail=TD(()=>{let e=this.live(),n=this.liveRefId();return !e||n==null?[]:No(e.playerId,n,e.timelines,this.anchorTime(),this.preS(),this.postS(),Lo)});readout=TD(()=>{if(!this.positions())return null;let e=this.scrubT(),n=Cn(this.parseTimelines(),e),i=null;n.length&&(i={fwd:n.reduce((r,l)=>r+l.fwd,0)/n.length,right:n.reduce((r,l)=>r+l.right,0)/n.length});let a=this.livePlayerAt(e);return {centroid:i,player:a}});constructor(){T(Le$1).onDestroy(()=>this.stopTimer()),Cu(()=>{this.anchorTime(),this.selector.set(this.map.reference()),this.pause(),this.scrubT.set(this.anchorTime());}),Cu(()=>{let e=this.canvas()?.nativeElement;this.benchTrails(),this.liveTrail(),this.scrubT(),this.readout(),e&&this.draw(e);});}onRefChange(e){this.selector.set(e==="boss"?{kind:"boss"}:{kind:"enemy",gameId:e});}onScrub(e){this.pause(),this.scrubT.set(e);}togglePlay(){this.playing()?this.pause():this.play();}play(){this.scrubT()>=this.windowEnd()-1e-6&&this.scrubT.set(this.windowStart()),this.playing.set(true),this.stopTimer(),this.lastFrameMs=0;let e=n=>{let i=this.lastFrameMs?Math.min((n-this.lastFrameMs)/1e3,Ls):0;this.lastFrameMs=n;let a=this.scrubT()+i;this.scrubT.set(a>=this.windowEnd()?this.windowStart():a),this.rafId=requestAnimationFrame(e);};this.rafId=requestAnimationFrame(e);}pause(){this.playing.set(false),this.stopTimer();}stopTimer(){this.rafId!=null&&(cancelAnimationFrame(this.rafId),this.rafId=null);}livePlayerAt(e){let n=this.live(),i=this.liveRefId();if(!n||i==null)return null;let a=Se(n.timelines.get(i),e),r=Se(n.timelines.get(n.playerId),e);return !a||!r||a.mapID!=null&&r.mapID!=null&&a.mapID!==r.mapID?null:mt(r,a,e)}draw(e){let n=e.getContext("2d");if(!n)return;let i=globalThis.devicePixelRatio||1,a=e.clientWidth||600,r=e.clientHeight||420,l=Math.round(a*i),s=Math.round(r*i);(e.width!==l||e.height!==s)&&(e.width=l,e.height=s),n.setTransform(i,0,0,i,0,0),n.clearRect(0,0,a,r);let m=a/2,f=r/2,h=Math.min(a,r)/2-28,x=this.benchTrails(),y=this.liveTrail(),w=this.readout(),T=10;for(let A of x)for(let U of A)T=Math.max(T,U.dist);for(let A of y)T=Math.max(T,A.dist);T=Math.ceil(T/5)*5+5;let z=h/T,K=A=>[m+A.right*z,f-A.fwd*z],Me=getComputedStyle(e),J=A=>Me.getPropertyValue(A).trim(),xe=J("--gold"),tt=J("--border"),De=J("--muted"),Ie=J("--critical"),nt=J("--accent"),Yt=J("--map-dot-outline");n.strokeStyle=tt,n.fillStyle=De,n.font="11px system-ui, sans-serif",n.lineWidth=1;for(let A=5;A<=T;A+=5)n.beginPath(),n.arc(m,f,A*z,0,2*Math.PI),n.stroke(),n.fillText(`${A}y`,m+3,f-A*z+12);n.fillStyle=Ie,n.beginPath(),n.moveTo(m,f-9),n.lineTo(m-7,f+6),n.lineTo(m+7,f+6),n.closePath(),n.fill();let Xt=this.scrubT();n.strokeStyle=De,n.globalAlpha=.25,n.lineWidth=1.5;for(let A of x)n.beginPath(),A.forEach((U,le)=>{let[it,Dn]=K(U);le&&U.mapID===A[le-1].mapID?n.lineTo(it,Dn):n.moveTo(it,Dn);}),n.stroke();n.globalAlpha=1;let be=Cn(this.parseTimelines(),Xt);n.fillStyle=De;for(let A of be){let[U,le]=K(A);n.beginPath(),n.arc(U,le,3,0,2*Math.PI),n.fill();}if(w?.centroid){let[A,U]=K(w.centroid);n.strokeStyle=nt,n.lineWidth=2,n.beginPath(),n.arc(A,U,7,0,2*Math.PI),n.stroke();}if(y.length&&(n.strokeStyle=xe,n.globalAlpha=.5,n.lineWidth=2,n.beginPath(),y.forEach((A,U)=>{let[le,it]=K(A);U&&A.mapID===y[U-1].mapID?n.lineTo(le,it):n.moveTo(le,it);}),n.stroke(),n.globalAlpha=1),w?.player){let[A,U]=K(w.player),le=5;n.fillStyle=xe,n.beginPath(),n.moveTo(A,U-le),n.lineTo(A+le,U),n.lineTo(A,U+le),n.lineTo(A-le,U),n.closePath(),n.fill(),n.strokeStyle=Yt,n.lineWidth=1,n.stroke();}}static \u0275fac=function(n){return new(n||t)};static \u0275cmp=jI({type:t,selectors:[["wl-map-canvas"]],viewQuery:function(n,i){n&1&&pp(i.canvas,Es,5),n&2&&kE();},decls:3,vars:1,consts:[["canvas",""],[3,"error"],[1,"text-[13px]","text-[var(--muted)]"],[1,"mb-2","flex","flex-wrap","items-center","justify-end","gap-2"],["appearance","outline",1,"w-[200px]"],[3,"selectionChange","value"],["value","boss"],[1,"relative","rounded-lg","border","border-[var(--border)]","bg-[var(--surface-alt)]"],[1,"block","h-[420px]","w-full"],[1,"pointer-events-none","absolute","bottom-2","left-2","flex","flex-col","gap-0.5","text-[10px]"],[1,"text-[var(--gold)]"],[1,"text-[var(--muted)]"],[1,"text-[var(--accent)]"],[1,"text-[var(--critical)]"],[1,"mt-2","flex","items-center","gap-2"],["mat-icon-button","",3,"click"],[1,"min-w-0","flex-1"],["type","range","step","0.25",1,"block","w-full","accent-[var(--gold)]",3,"input","min","max","value"],[1,"mt-1","flex","justify-between","text-[10px]","text-[var(--muted)]"],[3,"value"]],template:function(n,i){if(n&1&&aE(0,Fs,1,1,"wl-load-state",1)(1,Os,2,0,"p",2)(2,Ns,36,16),n&2){let a;cE((a=i.loadError())?0:i.positions()?2:1,a);}},dependencies:[xb,Hd,hv,uv,Pt,Rt,dt,oo,io,Ke,Xe,Bt],encapsulation:2})}return t})();function $s(t,o){if(t&1){let e=vE();oi$1(0,"wl-flyover-panel",1),cp("closed",function(){tu(e);let i=_E();return nu(i.map.close())}),np(1,"wl-map-canvas"),bc();}if(t&2){let e=_E();tp("loadingText",e.map.overlayLoading()?"Loading your trail...":"");}}var Du=(()=>{class t{map=T(Vt);static \u0275fac=function(n){return new(n||t)};static \u0275cmp=jI({type:t,selectors:[["wl-map-panel"]],decls:1,vars:1,consts:[["heading","Positioning","closeLabel","Close map",3,"loadingText"],["heading","Positioning","closeLabel","Close map",3,"closed","loadingText"]],template:function(n,i){n&1&&aE(0,$s,2,1,"wl-flyover-panel",0),n&2&&cE(i.map.open()?0:-1);},dependencies:[Ao,$o],encapsulation:2})}return t})();var Tu=(()=>{class t{transform(e){return e?e.replace(/([A-Z])/g," $1").trim():""}static \u0275fac=function(n){return new(n||t)};static \u0275pipe=WI({name:"formatSpec",type:t,pure:true})}return t})();var Fu=(()=>{class t{transform(e){return e?Gb(e):""}static \u0275fac=function(n){return new(n||t)};static \u0275pipe=WI({name:"specIcon",type:t,pure:true})}return t})();var Ru=(()=>{class t{transform(e){return Wb(e??"")}static \u0275fac=function(n){return new(n||t)};static \u0275pipe=WI({name:"classIcon",type:t,pure:true})}return t})();function Bo(t){return !Number.isInteger(t)||t<=0?"":`https://assets.rpglogs.com/img/warcraft/bosses/${t}-icon.jpg`}var $u=(()=>{class t{transform(e){return e?Bo(e):""}static \u0275fac=function(n){return new(n||t)};static \u0275pipe=WI({name:"bossIcon",type:t,pure:true})}return t})();function Bs(t,o){if(t&1&&np(0,"img",0),t&2){let e=_E();tp("ngSrc",o)("width",e.size())("height",e.size())("alt",e.alt());}}var Vu=(()=>{class t{src=iF.required();alt=iF.required();size=iF(20);static \u0275fac=function(n){return new(n||t)};static \u0275cmp=jI({type:t,selectors:[["wl-art-icon"]],hostAttrs:[1,"inline-flex","items-center","shrink-0","align-middle"],inputs:{src:[1,"src"],alt:[1,"alt"],size:[1,"size"]},decls:1,vars:1,consts:[[1,"block","rounded-sm",3,"ngSrc","width","height","alt"]],template:function(n,i){if(n&1&&aE(0,Bs,1,4,"img",0),n&2){let a;cE((a=i.src())?0:-1,a);}},dependencies:[cf],encapsulation:2})}return t})();var Wo="wl.sel.postRaid",zo="wl.sel.preFight",Uu=(()=>{class t{savePostRaid(e){this._save(Wo,e,"SelectionStore.savePostRaid");}loadPostRaid(){return this._load(Wo,"SelectionStore.loadPostRaid")}savePreFight(e){this._save(zo,e,"SelectionStore.savePreFight");}loadPreFight(){return this._load(zo,"SelectionStore.loadPreFight")}_save(e,n,i){try{localStorage.setItem(e,JSON.stringify(n));}catch(a){ua$1(i,a);}}_load(e,n){try{let i=localStorage.getItem(e);return i?JSON.parse(i):null}catch(i){return ua$1(n,i),null}}static \u0275fac=function(n){return new(n||t)};static \u0275prov=oe({token:t,factory:t.\u0275fac,providedIn:"root"})}return t})();function Go(t,o,e){let n=t.get(o);return n===void 0&&(n=e(),t.set(o,n)),n}function et(t,o,e,n=2){return t>o+n*e}function Vo(t,o,e,n=2){return Math.abs(t-o)>n*e}function qo(t,o,e,n=2){return t<o-n*e}function Ho(t,o){return Math.max(0,(1-t/o)*100)}function Uo(t){return t.length===0?0:t.reduce((o,e)=>Math.abs(e)<Math.abs(o)?e:o)}function Ht(t,o){let e=t/60,n=Math.round(o.avg*e),i=Math.max(0,Math.round(n-o.stddev*e));return {expected:n,floor:i}}function j(t){return `${String(Math.floor(t/60)).padStart(2,"0")}:${String(Math.floor(t%60)).padStart(2,"0")}`}var jo={critical:0,warning:1,info:2,hold_suggestion:2,success:3};function pt(t){t.sort((o,e)=>(jo[o.severity]??4)-(jo[e.severity]??4));}function Ut(t,o,e){let n=[];if(!o.length)return n;for(let[i,a]of Object.entries(e)){let r=parseInt(i,10)-1;if(r<1||r>=o.length)continue;o[r]-o[r-1]-a.effective_cd_s<a.delay_s-a.band_s&&n.push({severity:"info",category:"hold_suggestion",timestamp_ms:Math.round(o[r]*1e3),measured:{value:j(o[r]),unit:`top ${j(a.target_s)}`},message:`${t} cast ${i} at ${j(o[r])}. ${a.count}/${a.total_samples} top parses hold to ${j(a.target_s)}.`,details:{remedy:`Hold ${t} to ${j(a.target_s)}.`,cd_name:t}});}return n}function Sn(t,o){let e=new Map;for(let n of t){let i=n.abilityGameID;if(i==null)continue;let a=n.timestamp-o;if(n.type==="applybuff"||n.type==="applydebuff")Go(e,i,()=>[]).push([a,null]);else if(n.type==="removebuff"||n.type==="removedebuff"){let r=e.get(i)??[];for(let l=r.length-1;l>=0;l--)if(r[l][1]==null){r[l][1]=a;break}}}return e}function Qo(t,o,e){return (t.get(o)??[]).some(([n,i])=>e>=n&&(i==null||e<=i))}function Ko(t,o,e){if(e<=0)return 0;let n=(t.get(o)??[]).map(([r,l])=>[Math.max(0,r),Math.min(e,l??e)]).filter(([r,l])=>l>r).sort((r,l)=>r[0]-l[0]),i=0,a=-1;for(let[r,l]of n){let s=Math.max(r,a);l>s&&(i+=l-s,a=l);}return i/e*100}var Ws=3,zs=1;function js(t,o){let e={};for(let n of t)n.type==="cast"&&n.abilityGameID&&(e[n.abilityGameID]??=[]).push((n.timestamp-o)/1e3);return e}function Yo(t){let o=(t.fEnd-t.fStart)/1e3,e=t.deaths.map(n=>(n.timestamp-t.fStart)/1e3);return {castTimes:js(t.casts,t.fStart),castEvents:t.casts,fStart:t.fStart,fightDurationS:o,aliveDurationS:e.length?Math.min(...e):o,selfAuras:Sn(t.buffs,t.fStart),targetAuras:Sn(t.debuffs,t.fStart),damage:t.damage}}function Le(t,o){return o==="up"?t.value+t.band:Math.max(0,t.value-t.band)}function Gs(t,o,e){return e==="either"?Math.abs(t)<=o:e==="before"?t>=0&&t<=o:t<=0&&-t<=o}function Vs(t,o,e,n,i){let a=Le(e,"up"),r=t.position??"before",l=o.castTimes,s=[...l[t.spell_id]??[]].sort((h,x)=>h-x),m=l[t.required_spell_id]??[],f=s.filter(h=>!m.some(x=>Gs(h-x,a,r)));return f.length?{severity:n,category:"rule_violation",timestamp_ms:Math.round(f[0]*1e3),label:`${t.spell_name} without ${t.required_spell_name}`,message:`${t.spell_name} without ${t.required_spell_name} inside ${Math.round(a)}s: ${f.length} of ${s.length} cast(s).`,measured:{value:`${f.length} / ${s.length}`,unit:"cast(s)"},details:i?{remedy:i}:void 0}:null}function Xo(t,o){return [...o[t.anchor_spell_id]??[]].sort((e,n)=>e-n).slice(1)}function qs(t,o,e,n,i){let a=Le(e,"down"),r=Xo(t,o.castTimes),l=t.spell_ids.flatMap((f,h)=>{let x=t.spell_names?.[h]??String(f);return r.flatMap(y=>(o.castTimes[f]??[]).filter(w=>w>=y-a&&w<y).map(w=>({spellName:x,castTime:w})))});if(!l.length)return null;let s=l.reduce((f,h)=>Math.min(f,h.castTime),1/0),m=[...new Set(l.map(f=>f.spellName))].join("/");return {severity:n,category:"rule_violation",timestamp_ms:Math.round(s*1e3),label:`${m} held before ${t.anchor_spell_name}`,message:`${m} used in the ${Math.round(a)}s the field keeps clear before ${t.anchor_spell_name}: ${l.length} charge(s).`,measured:{value:`${l.length}`,unit:"charge(s)"},details:i?{remedy:i}:void 0}}function Hs(t,o,e,n){let i=[...o.castTimes[t.spell_id]??[]].sort((l,s)=>l-s),a=i.filter(l=>Qo(o.selfAuras,t.buff_spell_id,l*1e3)!==(t.require==="inside"));if(!a.length)return null;let r=t.require==="inside"?"without":"during";return {severity:e,category:"rule_violation",timestamp_ms:Math.round(a[0]*1e3),label:`${t.spell_name} ${r} ${t.buff_spell_name}`,message:`${t.spell_name} ${r} ${t.buff_spell_name}: ${a.length} of ${i.length} cast(s).`,measured:{value:`${a.length} / ${i.length}`,unit:"cast(s)"},details:n?{remedy:n}:void 0}}function Zo(t,o){let e=t.on==="target"?o.targetAuras:o.selfAuras;return Ko(e,t.aura_spell_id,o.aliveDurationS*1e3)}function Us(t,o,e,n,i){let a=Le(e,"down"),r=Zo(t,o);return r<=0||r>=a?null:{severity:n,category:"rule_violation",label:`${t.aura_spell_name} uptime`,message:`${t.aura_spell_name} up ${Math.round(r)}% of the fight; the top parses hold ${Math.round(e.value)}%.`,measured:{value:`${Math.round(r)} / ${Math.round(e.value)}`,unit:"% uptime"},details:i?{remedy:i}:void 0}}function Qs(t,o,e){let n=Object.values(o.castTimes).flat();if(!n.length)return null;let i=Math.min(...n),a=i+e,r=i,l=0;for(let s of t.spell_ids){let m=(o.castTimes[s]??[]).filter(f=>f>=r&&f<=a).sort((f,h)=>f-h)[0];if(m==null)break;r=m,l++;}return {pullS:i,matched:l,completedS:l===t.spell_ids.length?r-i:null}}function Ks(t,o,e,n,i){let a=Le(e,"up"),r=Qs(t,o,a);return !r||r.completedS!=null?null:{severity:n,category:"rule_violation",timestamp_ms:Math.round(r.pullS*1e3),label:`Opener: ${t.spell_names.join(" > ")}`,message:`Opener reached ${r.matched} of ${t.spell_ids.length} steps in the ${Math.round(a)}s the top parses take.`,measured:{value:`${r.matched} / ${t.spell_ids.length}`,unit:"step(s)"},details:i?{remedy:i}:void 0}}function Ys(t,o,e){let n=o+e*1e3,i=n+Ws*1e3,a=new Set;for(let r of t)r.timestamp<n||r.timestamp>i||r.targetID!=null&&a.add(`${r.targetID}:${r.targetInstance??0}`);return a.size}function Jo(t,o){return [...o.castTimes[t.spell_id]??[]].sort((e,n)=>e-n).map(e=>({timeS:e,targets:Ys(o.damage,o.fStart,e)})).filter(({targets:e})=>e>0)}function Xs(t,o,e,n,i){let a=Jo(t,o);if(!a.length)return null;let r=Math.round(Le(e,t.bound==="min"?"down":"up")),l=a.filter(({targets:m})=>t.bound==="min"?m<r:m>r);if(!l.length)return null;let s=t.bound==="min"?`under ${r}`:`over ${r}`;return {severity:n,category:"rule_violation",timestamp_ms:Math.round(l[0].timeS*1e3),label:`${t.spell_name} at ${s} targets`,message:`${t.spell_name} cast at ${s} targets, where the field uses it around ${Math.round(e.value)}: ${l.length} of ${a.length} cast(s).`,measured:{value:`${l.length} / ${a.length}`,unit:"cast(s)"},details:i?{remedy:i}:void 0}}function ea(t,o){let e=[];for(let n of o.castEvents){if(n.type!=="cast"||n.abilityGameID!==t.spell_id||n.resourceActor!=null&&n.resourceActor!==zs)continue;let i=n.classResources?.find(a=>a.type===t.resource_type);i?.max&&e.push({timeS:(n.timestamp-o.fStart)/1e3,frac:i.amount/i.max});}return e}function Zs(t,o,e,n,i){let a=ea(t,o);if(!a.length)return null;let r=t.bound==="min"?Le(e,"down"):Le(e,"up"),l=a.filter(({frac:f})=>t.bound==="min"?f<r:f>r);if(!l.length)return null;let s=t.bound==="min"?"below":"above",m=Math.round(r*100);return {severity:n,category:"rule_violation",timestamp_ms:Math.round(l[0].timeS*1e3),label:`${t.spell_name} at ${s} ${m}% ${t.resource_name}`,message:`${t.spell_name} cast ${s} ${m}% ${t.resource_name}, where the field spends at ${Math.round(e.value*100)}%: ${l.length} of ${a.length} cast(s).`,measured:{value:`${l.length} / ${a.length}`,unit:"cast(s)"},details:i?{remedy:i}:void 0}}function ta(t,o){return (o.selfAuras.get(t.buff_spell_id)??[]).filter(([,e])=>e!=null&&e<o.fightDurationS*1e3)}function Js(t,o,e,n){let i=ta(t,o);if(!i.length)return null;let a=t.spend_spell_ids.flatMap(l=>o.castTimes[l]??[]),r=i.filter(([l,s])=>!a.some(m=>m*1e3>=l&&m*1e3<=s));return r.length?{severity:e,category:"rule_violation",timestamp_ms:Math.round(r[0][0]),label:`${t.buff_spell_name} wasted`,message:`${t.buff_spell_name} expired unspent ${r.length} of ${i.length} time(s).`,measured:{value:`${r.length} / ${i.length}`,unit:"proc(s)"},details:n?{remedy:n}:void 0}:null}var na={cooldown_pairing:"pairing",cd_hold:"cd hold",opener:"opener",rotation:"rotation",aoe_switch:"aoe"};function ed(t){switch(t.kind){case "aura_uptime_below":return t.on==="target"?["enemyAuras","deaths"]:["deaths"];case "cast_at_target_count":return ["damage"];case "cast_without_prior":case "hold_cooldown_for_anchor":case "cast_outside_buff":case "opening_sequence":case "resource_at_cast":case "proc_wasted":return []}}function Qt(t,o){return t.some(e=>ed(e.condition).includes(o))}function td(t){switch(t.kind){case "cast_without_prior":case "hold_cooldown_for_anchor":case "aura_uptime_below":case "opening_sequence":case "cast_at_target_count":case "resource_at_cast":return  true;case "cast_outside_buff":case "proc_wasted":return  false}}function ia(t){return t.filter(o=>o.rule.condition!=null&&(!td(o.rule.condition)||o.threshold!=null))}function oa(t,o,e,n,i){switch(t.kind){case "cast_outside_buff":return Hs(t,o,n,i);case "proc_wasted":return Js(t,o,n,i);case "cast_without_prior":return e&&Vs(t,o,e,n,i);case "hold_cooldown_for_anchor":return e&&qs(t,o,e,n,i);case "aura_uptime_below":return e&&Us(t,o,e,n,i);case "opening_sequence":return e&&Ks(t,o,e,n,i);case "cast_at_target_count":return e&&Xs(t,o,e,n,i);case "resource_at_cast":return e&&Zs(t,o,e,n,i)}}function aa(t,o){let e=n=>o.castTimes[n]?.length??0;switch(t.kind){case "cast_without_prior":return e(t.spell_id)>0;case "hold_cooldown_for_anchor":return Xo(t,o.castTimes).length>0&&t.spell_ids.some(n=>e(n)>0);case "cast_outside_buff":return e(t.spell_id)>0;case "aura_uptime_below":return Zo(t,o)>0;case "opening_sequence":return t.spell_ids.some(n=>e(n)>0);case "cast_at_target_count":return Jo(t,o).length>0;case "resource_at_cast":return ea(t,o).length>0;case "proc_wasted":return ta(t,o).length>0}}function ra(t,o){let e=[];for(let{rule:n,threshold:i}of t){if(!aa(n.condition,o))continue;let a=oa(n.condition,o,i,n.severity,n.action);a&&e.push(U($({},a),{rule_type:n.type,label:n.description??a.label}));}return e}function nd(t,o){if(o)return o;switch(t.kind){case "cast_without_prior":return `${t.spell_name} with ${t.required_spell_name}`;case "hold_cooldown_for_anchor":return `${t.spell_names.join("/")} held for ${t.anchor_spell_name}`;case "cast_outside_buff":return `${t.spell_name} ${t.require} ${t.buff_spell_name}`;case "aura_uptime_below":return `${t.aura_spell_name} uptime`;case "opening_sequence":return `Opener: ${t.spell_names.join(" > ")}`;case "cast_at_target_count":return `${t.spell_name} target count`;case "resource_at_cast":return `${t.spell_name} at ${t.resource_name}`;case "proc_wasted":return `${t.buff_spell_name} spent`}}function la(t,o){let e=[];for(let{rule:n,threshold:i}of t){let a=n.condition;aa(a,o)&&(oa(a,o,i,n.severity)||e.push(nd(a,n.description)));}return e}var id=new Set([2825,32182,80353,90355,264667,390386]),od=40,ad=30,rd=15,Mn=50,sa=.5;function da(t){return t.used_sample_count/t.sample_count}function ld(t,o,e,n,i){return o===0&&e>=1?{severity:"critical",category:"lost_cooldown",cd_name:t,measured:{value:`0 / ${e}`,unit:"cast(s)"},message:`${t} unused. Expected ${e} on a ${j(i)} fight.`,details:{remedy:`Use ${t} ${e}x this fight.`}}:o>0&&o<n?{severity:"critical",category:"lost_cooldown",cd_name:t,measured:{value:`${o} / ${e}`,unit:"cast(s)"},message:`${t}: ${o} casts, expected ${e}. ${n-o} lost.`,details:{remedy:`Press ${t} ${n-o}x more - sooner off cooldown.`}}:null}function sd(t,o,e){if(!o.length)return null;let n=o[0]/1e3;if(!et(n,e.avg_first_cast_s,e.stddev_first_cast_s))return null;let i=(n-e.avg_first_cast_s).toFixed(0);return {severity:"warning",category:"cooldown_delay",cd_name:t,timestamp_ms:o[0],measured:{value:`+${i}s`,unit:`top ${j(e.avg_first_cast_s)}`},message:`${t} opened at ${j(n)}, ${i}s late. Top: ${j(e.avg_first_cast_s)}.`,details:{remedy:`Open with ${t} earlier.`}}}function dd(t,o,e,n,i){if(n===null||!o.length)return {blAligned:false,findings:[]};let a=o.filter(s=>{let m=s/1e3;return m>=n-ad&&m<=n+od+rd}),r=a.length>0,l=[];if(!r&&i)l.push({severity:"critical",category:"cooldown_alignment",cd_name:t,timestamp_ms:o[0],measured:{value:"missed",unit:"BL"},message:`${t} missed Bloodlust (BL at ${j(n)}, first cast at ${j(o[0]/1e3)}).`,details:{remedy:`Align ${t} with Bloodlust.`}});else if(r&&e.avg_bl_offset_s!=null&&e.stddev_bl_offset_s!=null){let s=a.map(f=>f/1e3-n),m=Uo(s);if(Vo(m,e.avg_bl_offset_s,e.stddev_bl_offset_s)){let f=m>e.avg_bl_offset_s?"late":"early",h=a[s.indexOf(m)];l.push({severity:"warning",category:"cooldown_alignment",cd_name:t,timestamp_ms:h,measured:{value:f,unit:"in BL"},message:`${t} ${f} in the Bloodlust window.`,details:{remedy:`Tighten ${t} to the Bloodlust window.`}});}}return {blAligned:r,findings:l}}function cd(t,o,e){let n=[];if(e.avg_gap_s==null||e.stddev_gap_s==null)return n;for(let i=1;i<o.length;i++){let a=(o[i]-o[i-1])/1e3;et(a,e.avg_gap_s,e.stddev_gap_s)&&n.push({severity:"warning",category:"cooldown_delay",cd_name:t,timestamp_ms:o[i],measured:{value:`${a.toFixed(0)}s`,unit:`avg ${e.avg_gap_s.toFixed(0)}s`},message:`${t} at ${j(o[i]/1e3)}: ${a.toFixed(0)}s gap, top ${e.avg_gap_s.toFixed(0)}s.`,details:{remedy:`Press ${t} sooner - top gap ${e.avg_gap_s.toFixed(0)}s.`}});}return n}function md(t,o,e){if(t.length<2||e.downtime_threshold_ms==null)return null;let n=0;for(let m=1;m<t.length;m++){let f=t[m]-t[m-1];f>e.downtime_threshold_ms&&(n+=f);}let i=n/1e3,a=e.top_avg_efficiency,r=e.top_efficiency_stddev,l=Ho(i,o);return qo(l,a,r,1)?{severity:"warning",category:"cast_efficiency",label:"Low cast efficiency",measured:{value:`${l.toFixed(1)}%`,unit:`top ${a.toFixed(0)}%`},message:`${l.toFixed(1)}% cast efficiency, ${i.toFixed(1)}s idle. Top: ${a.toFixed(0)}%.`,details:{remedy:`Fill ${i.toFixed(1)}s of gaps. Top: ${a.toFixed(0)}%.`}}:null}function pd(t,o,e,n,i){let a=t.name,r=o.length;if(t.talent_gated&&r===0)return null;if(!e)return {success:r>0?{severity:"success",category:"cooldown_usage",cd_name:a,message:`${a}: ${r} casts (no bench data).`}:null,scan:{issues:[],holds:[],blAligned:false}};let l=e.bl_pct>=Mn,{expected:s,floor:m}=Ht(n,e.uses_per_min),f=[];if(da(e)>=sa){let w=ld(a,r,s,m,n);w&&f.push(w);let T=sd(a,o,e);T&&f.push(T);}let h=dd(a,o,e,i,l);f.push(...h.findings),f.push(...cd(a,o,e));let x=Ut(a,o.map(w=>w/1e3),e.hold_targets);return {success:f.length||r===0?null:{severity:"success",category:"cooldown_usage",cd_name:a,message:`${a} - ${r}/${s} casts${h.blAligned&&l?", BL-aligned":""}.`},scan:{issues:f,holds:x,blAligned:h.blAligned}}}function fd(t){let{fStart:o,fEnd:e,castEvents:n,buffEvents:i,cooldowns:a,bench:r}=t,l=(e-o)/1e3,s=n.filter(y=>y.type==="cast"&&y.timestamp>=o&&y.timestamp<=e).sort((y,w)=>y.timestamp-w.timestamp),m=[],f=null;for(let y of i)if(y.type==="applybuff"&&id.has(y.abilityGameID)&&y.timestamp>=o&&y.timestamp<=e){f=(y.timestamp-o)/1e3;break}let h=r.per_cd_benchmarks??{};for(let y of a){let w=s.filter(z=>z.abilityGameID===y.spell_id).map(z=>z.timestamp-o),T=pd(y,w,h[y.name],l,f);T&&(T.scan.issues.length?m.push(...T.scan.issues):T.success&&m.push(T.success),w.length&&m.push(...T.scan.holds));}let x=md(s.map(y=>y.timestamp-o),l,r);return x&&m.push(x),pt(m),m}var ud={lost_cooldown:"lost cast",cooldown_delay:"held",cooldown_alignment:"BL miss",cast_efficiency:"downtime",hold_suggestion:"hold"};function ca(t,o,e){let n=o[t]??null;return n!=null?{spellId:n,icon:e[n].icon,rowName:e[n].name}:{spellId:null,icon:"",rowName:t}}function hd(t){let o=[],e={},n=new Set;for(let i of t){if(i.severity==="success"){i.cd_name&&n.add(i.cd_name);continue}i.category==="hold_suggestion"&&i.details?.cd_name?(e[i.details.cd_name]??={issues:[],holds:[]}).holds.push(i):i.category==="rule_violation"||!i.cd_name?o.push(i):(e[i.cd_name]??={issues:[],holds:[]}).issues.push(i);}return {ruleFindings:o,byName:e,successNames:n}}function _d(t){return t.map(o=>({severity:o.severity==="critical"?"critical":o.severity==="info"?"info":"warning",name:"",icon:"",what:o.label,chip:o.rule_type?na[o.rule_type]:void 0,measured:o.measured??{value:"-"},fix:o.details?.remedy}))}function gd(t,o,e){let n=[];for(let[i,a]of Object.entries(t)){if(!a.issues.length&&!a.holds.length)continue;let{spellId:r,icon:l,rowName:s}=ca(i,o,e);for(let m of [...a.issues,...a.holds])n.push({severity:m.severity==="critical"?"critical":"warning",name:s,spellId:r,icon:l,timestampMs:m.timestamp_ms??null,chip:ud[m.category],measured:m.measured??{value:"-"},fix:m.details?.remedy});}return n}function vd(t,o,e){let{byName:n,successNames:i}=t,a=[];for(let r of i)if(!n[r]||!n[r].issues.length&&!n[r].holds.length){let{spellId:l,icon:s,rowName:m}=ca(r,o,e);a.push({name:m,spellId:l,icon:s});}return a}function xd(t,o,e){let n=hd(t);return {ruleRows:_d(n.ruleFindings),offensiveRows:gd(n.byName,o,e),onPlan:vd(n,o,e)}}function bd(t,o,e){return [...t].sort((i,a)=>{let r=i.opener_priority??99,l=a.opener_priority??99;return r!==l?r-l:i.name.localeCompare(a.name)}).map(i=>{let a=o[i.name],r=a?.majority_hold&&a.hold_targets?Object.entries(a.hold_targets).sort((f,h)=>Number(f[0])-Number(h[0])).map(([f,h])=>({castIndex:Number(f),targetS:h.target_s})):[],l=i.spell_id??null,s=l!=null?e[l]:void 0;l!=null&&!s&&ua$1("buildCdPlan: ability id missing from ability map",l);let m=a!=null&&da(a)>=sa;return {name:i.name,spellId:l,icon:s?.icon??"",firstCastS:m?a.avg_first_cast_s:null,uses:a?.avg_uses??null,usesPerMin:m?a.uses_per_min.avg:null,bloodlust:(a?.bl_pct??0)>=Mn,bloodlustPct:(a?.bl_pct??0)>=Mn?a.bl_pct:null,holds:r,rule:i.usage_rule??null}})}var uh=(()=>{class t{source=T(Xa$1);wclApi=T(ve);async loadPlayerView(e,n,i,a,r){let l=await this.source.getBench(e,n);if(!l.ok)return l;try{let m=(await this.wclApi.getReport(i)).fights.find(be=>be.id===a);if(!m)return fa$1("Fight not found in this report.","rotation.player-view");let f=ia(l.value.rules),h=f.map(be=>be.rule),[x,y,w,T,z]=await Promise.all([this.wclApi.getAllEvents(i,a,"Casts",m.startTime,m.endTime,r,!0),this.wclApi.getAllEvents(i,a,"Buffs",m.startTime,m.endTime,r),Qt(h,"enemyAuras")?this.wclApi.getAllEvents(i,a,"Debuffs",m.startTime,m.endTime,void 0,!1,"Enemies"):Promise.resolve([]),Qt(h,"damage")?this.wclApi.getAllEvents(i,a,"DamageDone",m.startTime,m.endTime,r):Promise.resolve([]),Qt(h,"deaths")?this.wclApi.getAllEvents(i,a,"Deaths",m.startTime,m.endTime):Promise.resolve([])]),K=w.filter(be=>be.sourceID===r),Me=z.filter(be=>be.targetID===r),J=fd({fStart:m.startTime,fEnd:m.endTime,castEvents:x,buffEvents:y,cooldowns:l.value.major_cooldowns,bench:l.value}),xe=Yo({casts:x,buffs:y,debuffs:K,damage:T,deaths:Me,fStart:m.startTime,fEnd:m.endTime}),tt=ra(f,xe),De=[...J,...tt];pt(De);let{ruleRows:Ie,offensiveRows:nt,onPlan:Yt}=xd(De,l.value.cd_spell_ids,l.value.ability_icons),Xt=la(f,xe);return ri({ruleRows:Ie,ruleOnPlan:Xt,offensiveRows:nt,onPlan:Yt})}catch(s){return ua$1(`RotationFeatureService.loadPlayerView ${i}:${a}`,s),ma$1(s,"rotation.player-view")}}async loadPlanView(e,n){let i=await this.source.getBench(e,n);return i.ok?ri({rows:bd(i.value.major_cooldowns,i.value.per_cd_benchmarks,i.value.ability_icons)}):i}static \u0275fac=function(n){return new(n||t)};static \u0275prov=oe({token:t,factory:t.\u0275fac,providedIn:"root"})}return t})();var Kt=t=>(t.amount||0)+(t.absorbed||0),yd=.5;function wd(t){return t.used_sample_count/t.sample_count}function Cd(t,o,e,n,i,a,r,l){let s=o.map(([m,f])=>{let h=f??l;return {start_s:Math.round(m*10)/10,end_s:Math.round(h*10)/10,dmg_during:Math.round(n(m,h))}});return s.length?s:e.filter(m=>m.type==="cast"&&m.abilityGameID===t&&m.timestamp>=a&&m.timestamp<=r).map(m=>{let f=i(m.timestamp)/1e3;return {start_s:Math.round(f*10)/10,end_s:Math.round(f*10)/10,dmg_during:0}})}function Sd(t,o,e,n,i,a){if(!t.length)return [];let r=h=>h-i,l=n.filter(h=>h.type==="damage"),s={};for(let h of e){let x=h.abilityGameID,y=r(h.timestamp)/1e3;if(h.type==="applybuff")(s[x]??=[]).push([y,null]);else if(h.type==="removebuff"){for(let w=(s[x]?.length??0)-1;w>=0;w--)if(s[x][w][1]===null){s[x][w][1]=y;break}}}let m=(h,x)=>l.reduce((y,w)=>{let T=r(w.timestamp)/1e3;return T>=h&&T<=x?y+Kt(w):y},0),f=(a-i)/1e3;return t.map(h=>{let x=h.spell_id,y=Cd(x,s[x]||[],o,m,r,i,a,f),w=y.map(z=>z.start_s).sort((z,K)=>z-K),T={name:h.name,spell_id:x,cooldown:h.cooldown,uses:y.length,cast_times_s:w,windows:y};return h.talent_gated&&(T.talent_gated=true),T})}function Md(t,o,e){let n=[];if(e.avg_gap_s==null||e.stddev_gap_s==null)return n;let i=e.avg_gap_s;for(let a=1;a<o.length;a++){let r=o[a]-o[a-1];et(r,i,e.stddev_gap_s)&&n.push({severity:"warning",category:"cooldown_delay",cd_name:t,timestamp_ms:Math.round(o[a]*1e3),measured:{value:`${r.toFixed(0)}s`,unit:`avg ${i.toFixed(0)}s`},message:`${t} at ${j(o[a])}: ${r.toFixed(0)}s gap, top ${i.toFixed(0)}s.`,details:{remedy:`Use ${t} sooner after it resets.`}});}return n}function Dd(t,o,e){let{name:n,uses:i,cast_times_s:a}=t;if(t.talent_gated&&i===0)return [];if(!o)return i>0?[{severity:"success",category:"cooldown_usage",cd_name:n,message:`${n}: ${i} uses (no bench data).`}]:[];let{expected:r,floor:l}=Ht(e,o.uses_per_min),s=[],m=wd(o)>=yd;m&&i===0&&r>=1?s.push({severity:"critical",category:"lost_cooldown",cd_name:n,timestamp_ms:void 0,measured:{value:`0 / ${r}`,unit:"use(s)"},message:`${n} unused. Expected ${r} on a ${j(e)} fight.`,details:{remedy:`Use ${n} ${r}x this fight.`}}):m&&i>0&&i<l&&s.push({severity:"critical",category:"lost_cooldown",cd_name:n,timestamp_ms:void 0,measured:{value:`${i} / ${r}`,unit:"use(s)"},message:`${n}: ${i} uses, expected ${r}. ${l-i} lost.`,details:{remedy:`Use ${n} ${l-i}x more.`}});let f=[];if(a?.length){let x=a[0];m&&et(x,o.avg_first_cast_s,o.stddev_first_cast_s)&&s.push({severity:"warning",category:"cooldown_delay",cd_name:n,timestamp_ms:Math.round(x*1e3),measured:{value:`+${(x-o.avg_first_cast_s).toFixed(0)}s`,unit:`top ${j(o.avg_first_cast_s)}`},message:`${n} first used at ${j(x)}, ${(x-o.avg_first_cast_s).toFixed(0)}s late. Top: ${j(o.avg_first_cast_s)}.`,details:{remedy:`Use ${n} earlier.`}}),s.push(...Md(n,a,o)),f.push(...Ut(n,a,o.hold_targets));}let h=s.length?s:i>0?[{severity:"success",category:"cooldown_usage",cd_name:n,message:`${n} - ${i}/${r} uses.`}]:[];return i>0&&h.push(...f),h}function kd(t,o,e){let n=[];for(let i of t)n.push(...Dd(i,o[i.name],e));return pt(n),n}function Td(t,o,e){let n=o.filter(i=>i.timestamp>=e&&Kt(i)>0).sort((i,a)=>i.timestamp-a.timestamp);return t.map(i=>{let a=f=>f>=i.time_s&&f<i.time_s+i.window_length_s,r=n.filter(f=>a((f.timestamp-e)/1e3)),l=r.reduce((f,h)=>f+Kt(h),0),s={};for(let f of r){if(!f.abilityGameID)continue;let h=zt(f.abilityGameID);s[h]=(s[h]||0)+Kt(f);}let m=Object.entries(s).sort((f,h)=>h[1]-f[1]).slice(0,6).map(([f,h])=>({spell_id:parseInt(f,10),damage:Math.round(h)}));return {time_s:i.time_s,window_damage:Math.round(l),ability_breakdown:m}})}var Ed=3;function Id(t,o,e=Ed){if(!o)return  false;let n=t.time_s-e,i=t.time_s+t.window_length_s+e;return o.windows.some(a=>a.start_s<=i&&a.end_s>=n)}var Fd="covered",Od="no defensive used",Ad="defensive used wrongly",Rd="defensive needed, unused";function Pd(t,o,e,n,i){return n?{status:"muted",icon:"schedule",note:""}:t===null?{status:"muted",icon:"help_outline",note:""}:t>o+e?{status:"bad",icon:"error",note:i?Ad:Rd}:{status:"good",icon:"check_circle",note:i?Fd:Od}}function Nd(t,o,e){let n={};for(let i of o?.ability_breakdown??[])n[i.spell_id]=i;return t.map(i=>({spellId:i.spell_id,label:e[i.spell_id].name,icon:e[i.spell_id].icon,playerPct:n[i.spell_id]?.damage??null,topAvg:i.avg_damage,topMin:i.min_damage,topMax:i.max_damage}))}function Ld(t){return {timeS:t.time_s,refGameId:t.ref_game_id??null,windowLengthS:t.window_length_s}}function $d(t,o){return {timeS:t.time_s,windowLengthS:t.window_length_s,key:`defensive-${o}`}}function Dh(t){return {timeS:t/1e3,windowLengthS:0,key:`defensive-find-${t}`}}function Bd({topWindows:t,playerWindows:o,playerDefensives:e,fightDurationS:n,abilities:i}){let a=[],r=[],l=[];return t.forEach((s,m)=>{let f=s.time_s>n,h=f?null:o[m]??null,x=h?.window_damage??null,y=s.defensive_name??s.common_defensives?.[0]??"",w=e.find(xe=>xe.name===y),T=Id(s,w),{status:z,icon:K,note:Me}=Pd(x,s.dmg_max,s.dmg_stddev,f,T),J=s.spell_id==null&&y?[y]:[];Me&&J.push(Me),a.push({timeStartS:s.time_s,timeEndS:s.time_s+s.window_length_s,spells:jt(s.spell_id!=null?[s.spell_id]:[],i),labels:J,status:z,statusIcon:K,overview:{label:"",icon:"",playerPct:x,topAvg:s.dmg_avg,topMin:s.dmg_min,topMax:s.dmg_max},detailRows:Nd(s.ability_breakdown,h,i)}),r.push(Ld(s)),l.push($d(s,m));}),{windows:a,anchors:r,clipAnchors:l}}function Wd(t){if(!t?.defensives?.length)return [];let o=t.per_defensive_benchmarks??{},e=t.defensive_windows??[];return t.defensives.map(n=>{let i=o[n.name],a=e.filter(m=>(m.defensive_name??m.common_defensives?.[0])===n.name).map(m=>m.time_s).sort((m,f)=>m-f),r=i?.majority_hold&&i.hold_targets?Object.entries(i.hold_targets).sort((m,f)=>Number(m[0])-Number(f[0])).map(([m,f])=>({castIndex:Number(m),targetS:f.target_s})):[],l=n.spell_id??null,s=l!=null?t.ability_icons[l]:void 0;return l!=null&&!s&&ua$1("buildDefensivePlanRows: ability id missing from ability map",l),{name:n.name,spellId:l,icon:s?.icon??"",uses:i?.avg_uses??null,firstCastS:i?.avg_first_cast_s??null,windowsS:a,holds:r,rule:n.usage_rule??null}}).filter(n=>n.uses!=null||n.firstCastS!=null||n.windowsS.length||n.holds.length||n.rule)}var kh=(()=>{class t{source=T(Za$1);wclApi=T(ve);async loadAnalysisView(e,n,i,a,r){let l=await this.source.getBench(e,n);if(!l.ok)return l;try{let m=(await this.wclApi.getReport(i)).fights.find(Ie=>Ie.id===a);if(!m)return ri({findings:[],spellIdsByName:l.value.cd_spell_ids,iconByName:{},windows:[],anchors:[],clipAnchors:[]});let f=m.startTime,h=m.endTime,x=(h-f)/1e3,[y,w,T]=await Promise.all([this.wclApi.getAllEvents(i,a,"Casts",f,h,r),this.wclApi.getAllEvents(i,a,"Buffs",f,h,r),this.wclApi.getAllEvents(i,a,"DamageTaken",f,h,r)]),z=Sd(l.value.defensives,y,w,T,f,h),K=l.value.defensives.length&&z.length?kd(z,l.value.per_defensive_benchmarks,x):[],Me=Td(l.value.defensive_windows,T,f),J={};for(let[Ie,nt]of Object.entries(l.value.cd_spell_ids))J[Ie]=l.value.ability_icons[nt].icon;let{windows:xe,anchors:tt,clipAnchors:De}=Bd({topWindows:l.value.defensive_windows,playerWindows:Me,playerDefensives:z,fightDurationS:x,abilities:l.value.ability_icons});return ri({findings:K,spellIdsByName:l.value.cd_spell_ids,iconByName:J,windows:xe,anchors:tt,clipAnchors:De})}catch(s){return ua$1(`DefensiveFeatureService.loadAnalysisView ${i}:${a}`,s),ma$1(s,"defensive.player-view")}}async loadPlan(e,n){let i=await this.source.getBench(e,n);return i.ok?ri({rows:Wd(i.value)}):i}static \u0275fac=function(n){return new(n||t)};static \u0275prov=oe({token:t,factory:t.\u0275fac,providedIn:"root"})}return t})();
export{$u as $,Aa as A,Bt as B,Cm as C,Du as D,Fu as F,Jm as J,Ke as K,Ot as O,Pt as P,Rt as R,Sm as S,Tu as T,Uu as U,Vt as V,Wt as W,Xe as X,Yi as Y,Ze as Z,_o as _,ap as a,Vu as b,Ru as c,dt as d,At as e,Ji as f,$t as g,hm as h,io as i,Je as j,kh as k,Dh as l,mf as m,uo as n,oo as o,lo as p,Ao as q,so as s,uh as u,ve as v,zf as z};//# sourceMappingURL=chunk-VN4xuRdm.js.map
