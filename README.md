...
See [`CLAUDE.md`](./CLAUDE.md) for the development entry point: architecture at a glance, commands, and the router into the on-demand skills under [`.claude/skills/`](./.claude/skills/) that hold the detailed conventions (change contract, writing, WCL data, SimulationCraft).
